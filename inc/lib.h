...
int	sys_env_set_trapframe(envid_t env, struct Trapframe *tf);int	sys_env_set_pgfault_upcall(envid_t env, void *upcall);
...
int sys_e1000_transmit(char *data,int len);
int sys_e1000_recieve(char *data,int *len);
