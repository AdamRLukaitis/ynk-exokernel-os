...
exit(void)
{
  ...
  8000a4:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a7:	e8 ee 05 00 00       	call   80069a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800124:	00 
  800125:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80012c:	00 
  80012d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800134:	00 
  800135:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80013c:	e8 35 16 00 00       	call   801776 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b6:	00 
  8001b7:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001be:	00 
  8001bf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c6:	00 
  8001c7:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001ce:	e8 a3 15 00 00       	call   801776 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800209:	00 
  80020a:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800211:	00 
  800212:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800219:	00 
  80021a:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800221:	e8 50 15 00 00       	call   801776 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80025c:	00 
  80025d:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800264:	00 
  800265:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026c:	00 
  80026d:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800274:	e8 fd 14 00 00       	call   801776 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002af:	00 
  8002b0:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002b7:	00 
  8002b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002bf:	00 
  8002c0:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002c7:	e8 aa 14 00 00       	call   801776 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800302:	00 
  800303:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80030a:	00 
  80030b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800312:	00 
  800313:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80031a:	e8 57 14 00 00       	call   801776 <_panic>
int
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800355:	00 
  800356:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80035d:	00 
  80035e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800365:	00 
  800366:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80036d:	e8 04 14 00 00       	call   801776 <_panic>
int
...
sys_ipc_recv(void *dstva)
{
  ...
  8003ca:	00 
  8003cb:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003d2:	00 
  8003d3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003da:	00 
  8003db:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003e2:	e8 8f 13 00 00       	call   801776 <_panic>
...
sys_e1000_transmit(char *data,int len)
{
  ...
  80042f:	7e 28                	jle    800459 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800431:	89 44 24 10          	mov    %eax,0x10(%esp)
  800435:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80043c:	00 
  80043d:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800444:	00 
  800445:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80044c:	00 
  80044d:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800454:	e8 1d 13 00 00       	call   801776 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800482:	7e 28                	jle    8004ac <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800484:	89 44 24 10          	mov    %eax,0x10(%esp)
  800488:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80048f:	00 
  800490:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800497:	00 
  800498:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80049f:	00 
  8004a0:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8004a7:	e8 ca 12 00 00       	call   801776 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005af:	8b 04 95 74 26 80 00 	mov    0x802674(,%edx,4),%eax
  ...
  8005ca:	c7 04 24 f8 25 80 00 	movl   $0x8025f8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800659:	e8 d0 fb ff ff       	call   80022e <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800757:	e8 7f fa ff ff       	call   8001db <sys_page_map>
  ...
  800792:	e8 44 fa ff ff       	call   8001db <sys_page_map>
...
err:
  ...
  8007ab:	e8 7e fa ff ff       	call   80022e <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007b0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007b4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007bb:	e8 6e fa ff ff       	call   80022e <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80081f:	c7 04 24 39 26 80 00 	movl   $0x802639,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008f7:	c7 04 24 55 26 80 00 	movl   $0x802655,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009b0:	c7 04 24 18 26 80 00 	movl   $0x802618,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c34:	c7 44 24 0c 88 26 80 	movl   $0x802688,0xc(%esp)
  800c3b:	00 
  800c3c:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  800c43:	00 
  800c44:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c4b:	00 
  800c4c:	c7 04 24 a4 26 80 00 	movl   $0x8026a4,(%esp)
  800c53:	e8 1e 0b 00 00       	call   801776 <_panic>
	assert(r <= PGSIZE);
  800c58:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c5d:	7e 24                	jle    800c83 <devfile_read+0x84>
  800c5f:	c7 44 24 0c af 26 80 	movl   $0x8026af,0xc(%esp)
  800c66:	00 
  800c67:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  800c6e:	00 
  800c6f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c76:	00 
  800c77:	c7 04 24 a4 26 80 00 	movl   $0x8026a4,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d46:	c7 44 24 04 bb 26 80 	movl   $0x8026bb,0x4(%esp)
  800d4d:	00 
...
fd2sockid(int fd)
{
  ...
  800e05:	8b 0d 20 30 80 00    	mov    0x803020,%ecx
...
alloc_sockfd(int sockid)
{
  ...
  800e4c:	e8 36 f3 ff ff       	call   800187 <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801167:	c7 44 24 0c c7 26 80 	movl   $0x8026c7,0xc(%esp)
  80116e:	00 
  80116f:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  801176:	00 
  801177:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80117e:	00 
  80117f:	c7 04 24 dc 26 80 00 	movl   $0x8026dc,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011c5:	c7 44 24 0c e8 26 80 	movl   $0x8026e8,0xc(%esp)
  8011cc:	00 
  8011cd:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  8011d4:	00 
  8011d5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011dc:	00 
  8011dd:	c7 04 24 dc 26 80 00 	movl   $0x8026dc,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801260:	c7 44 24 04 f4 26 80 	movl   $0x8026f4,0x4(%esp)
  801267:	00 
  ...
  801282:	00 00 00 
	stat->st_dev = &devpipe;
  801285:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  80128c:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8012b0:	e8 79 ef ff ff       	call   80022e <sys_page_unmap>
  ...
  8012c8:	e8 61 ef ff ff       	call   80022e <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801326:	c7 04 24 fb 26 80 00 	movl   $0x8026fb,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801364:	75 41                	jne    8013a7 <devpipe_write+0x6b>
			...
			sys_yield();
  801366:	e8 fd ed ff ff       	call   800168 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013e4:	75 31                	jne    801417 <devpipe_read+0x63>
			...
			sys_yield();
  8013e6:	e8 7d ed ff ff       	call   800168 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801457:	e8 2b ed ff ff       	call   800187 <sys_page_alloc>
  ...
  801491:	e8 f1 ec ff ff       	call   800187 <sys_page_alloc>
  ...
  8014c0:	e8 c2 ec ff ff       	call   800187 <sys_page_alloc>
  ...
  8014f9:	e8 dd ec ff ff       	call   8001db <sys_page_map>
  ...
  801504:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  801519:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015e0:	c7 44 24 04 13 27 80 	movl   $0x802713,0x4(%esp)
  8015e7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80163d:	e8 78 ea ff ff       	call   8000ba <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801667:	eb 2a                	jmp    801693 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801669:	e8 fa ea ff ff       	call   800168 <sys_yield>
	int c;
  ...
  801670:	e8 63 ea ff ff       	call   8000d8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8016af:	e8 06 ea ff ff       	call   8000ba <sys_cputs>
}
  8016b4:	c9                   	leave  
  8016b5:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  80170b:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
opencons(void)
{
  ...
  801748:	e8 3a ea ff ff       	call   800187 <sys_page_alloc>
		return r;
  ...
  801753:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801781:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801787:	e8 bd e9 ff ff       	call   800149 <sys_getenvid>
  ...
  8017a2:	c7 04 24 20 27 80 00 	movl   $0x802720,(%esp)
  ...
  8017b8:	e8 51 00 00 00       	call   80180e <vcprintf>
	cprintf("\n");
  8017bd:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017f9:	e8 bc e8 ff ff       	call   8000ba <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801862:	e8 53 e8 ff ff       	call   8000ba <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801968:	0f be 80 43 27 80 00 	movsbl 0x802743(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801a83:	ff 24 8d 80 28 80 00 	jmp    *0x802880(,%ecx,4)
  ...
  801b4f:	c7 44 24 08 a1 26 80 	movl   $0x8026a1,0x8(%esp)
  801b56:	00 
  ...
  801b81:	b8 54 27 80 00       	mov    $0x802754,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802204:	e8 94 e1 ff ff       	call   80039d <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80227e:	e8 f7 e0 ff ff       	call   80037a <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802283:	eb 1c                	jmp    8022a1 <ipc_send+0x51>
	{
		sys_yield();
  802285:	e8 de de ff ff       	call   800168 <sys_yield>
  ...
  80229c:	e8 d9 e0 ff ff       	call   80037a <sys_ipc_try_send>
	// LAB 4: Your code here.
