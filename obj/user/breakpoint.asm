...
libmain(int argc, char **argv)
{
  ...
  800051:	e8 dd 00 00 00       	call   800133 <sys_getenvid>
  ...
  80006e:	a3 00 30 80 00       	mov    %eax,0x803000
	...
	umain(argc, argv);
  800073:	89 74 24 04          	mov    %esi,0x4(%esp)
  800077:	89 1c 24             	mov    %ebx,(%esp)
  80007a:	e8 b4 ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  80007f:	e8 07 00 00 00       	call   80008b <exit>
}
...
exit(void)
{
  ...
  80008e:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800091:	e8 e4 05 00 00       	call   80067a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80010e:	00 
  80010f:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800116:	00 
  800117:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011e:	00 
  80011f:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800126:	e8 2b 16 00 00       	call   801756 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a0:	00 
  8001a1:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8001a8:	00 
  8001a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b0:	00 
  8001b1:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8001b8:	e8 99 15 00 00       	call   801756 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f3:	00 
  8001f4:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8001fb:	00 
  8001fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800203:	00 
  800204:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80020b:	e8 46 15 00 00       	call   801756 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800246:	00 
  800247:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  80024e:	00 
  80024f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800256:	00 
  800257:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80025e:	e8 f3 14 00 00       	call   801756 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800299:	00 
  80029a:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8002a1:	00 
  8002a2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a9:	00 
  8002aa:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8002b1:	e8 a0 14 00 00       	call   801756 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002ec:	00 
  8002ed:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8002f4:	00 
  8002f5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fc:	00 
  8002fd:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800304:	e8 4d 14 00 00       	call   801756 <_panic>
int
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033f:	00 
  800340:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800347:	00 
  800348:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034f:	00 
  800350:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800357:	e8 fa 13 00 00       	call   801756 <_panic>
int
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80037a:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80037d:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8003b4:	00 
  8003b5:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8003bc:	00 
  8003bd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c4:	00 
  8003c5:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8003cc:	e8 85 13 00 00       	call   801756 <_panic>
...
sys_time_msec(void)
{
  ...
  8003e4:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003e9:	89 d1                	mov    %edx,%ecx
  8003eb:	89 d3                	mov    %edx,%ebx
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800406:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  800419:	7e 28                	jle    800443 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041f:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800426:	00 
  800427:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  80042e:	00 
  80042f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800436:	00 
  800437:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80043e:	e8 13 13 00 00       	call   801756 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800451:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  800454:	bb 00 00 00 00       	mov    $0x0,%ebx
  800459:	b8 10 00 00 00       	mov    $0x10,%eax
  80045e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800461:	8b 55 08             	mov    0x8(%ebp),%edx
  800464:	89 df                	mov    %ebx,%edi
  ...
  80046c:	7e 28                	jle    800496 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80046e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800472:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800479:	00 
  80047a:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800481:	00 
  800482:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800489:	00 
  80048a:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800491:	e8 c0 12 00 00       	call   801756 <_panic>

int 
sys_e1000_recieve(char *data ,int *len)
{
	return (int) syscall (SYS_e1000_recieve,1,(uint32_t)data,(uint32_t)len,0,0,0);
  800496:	83 c4 2c             	add    $0x2c,%esp
  800499:	5b                   	pop    %ebx
  80049a:	5e                   	pop    %esi
  80049b:	5f                   	pop    %edi
  80049c:	5d                   	pop    %ebp
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800639:	e8 da fb ff ff       	call   800218 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800737:	e8 89 fa ff ff       	call   8001c5 <sys_page_map>
  ...
  800772:	e8 4e fa ff ff       	call   8001c5 <sys_page_map>
...
err:
  ...
  80078b:	e8 88 fa ff ff       	call   800218 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800790:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800794:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80079b:	e8 78 fa ff ff       	call   800218 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e2c:	e8 40 f3 ff ff       	call   800171 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801290:	e8 83 ef ff ff       	call   800218 <sys_page_unmap>
  ...
  8012a8:	e8 6b ef ff ff       	call   800218 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801344:	75 41                	jne    801387 <devpipe_write+0x6b>
			...
			sys_yield();
  801346:	e8 07 ee ff ff       	call   800152 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013c4:	75 31                	jne    8013f7 <devpipe_read+0x63>
			...
			sys_yield();
  8013c6:	e8 87 ed ff ff       	call   800152 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801437:	e8 35 ed ff ff       	call   800171 <sys_page_alloc>
  ...
  801471:	e8 fb ec ff ff       	call   800171 <sys_page_alloc>
  ...
  8014a0:	e8 cc ec ff ff       	call   800171 <sys_page_alloc>
  ...
  8014d9:	e8 e7 ec ff ff       	call   8001c5 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80161d:	e8 82 ea ff ff       	call   8000a4 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801647:	eb 2a                	jmp    801673 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801649:	e8 04 eb ff ff       	call   800152 <sys_yield>
	int c;
  ...
  801650:	e8 6d ea ff ff       	call   8000c2 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80168f:	e8 10 ea ff ff       	call   8000a4 <sys_cputs>
}
  801694:	c9                   	leave  
  801695:	c3                   	ret    
...
opencons(void)
{
  ...
  801728:	e8 44 ea ff ff       	call   800171 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801767:	e8 c7 e9 ff ff       	call   800133 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8017d9:	e8 c6 e8 ff ff       	call   8000a4 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801842:	e8 5d e8 ff ff       	call   8000a4 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021e4:	e8 9e e1 ff ff       	call   800387 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80225e:	e8 01 e1 ff ff       	call   800364 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802263:	eb 1c                	jmp    802281 <ipc_send+0x51>
	{
		sys_yield();
  802265:	e8 e8 de ff ff       	call   800152 <sys_yield>
  ...
  80227c:	e8 e3 e0 ff ff       	call   800364 <sys_ipc_try_send>
	// LAB 4: Your code here.
