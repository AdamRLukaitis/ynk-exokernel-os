...
libmain(int argc, char **argv)
{
  ...
  80005a:	e8 dd 00 00 00       	call   80013c <sys_getenvid>
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 eb 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 3f 00 00 00       	call   8000ea <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80010a:	7e 28                	jle    800134 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80010c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800110:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800117:	00 
  800118:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80011f:	00 
  800120:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800127:	00 
  800128:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80012f:	e8 32 16 00 00       	call   801766 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019c:	7e 28                	jle    8001c6 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  80019e:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001a2:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001a9:	00 
  8001aa:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001b1:	00 
  8001b2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b9:	00 
  8001ba:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001c1:	e8 a0 15 00 00       	call   801766 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ef:	7e 28                	jle    800219 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001f1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001f5:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001fc:	00 
  8001fd:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800204:	00 
  800205:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020c:	00 
  80020d:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800214:	e8 4d 15 00 00       	call   801766 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800242:	7e 28                	jle    80026c <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800244:	89 44 24 10          	mov    %eax,0x10(%esp)
  800248:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80024f:	00 
  800250:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800257:	00 
  800258:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025f:	00 
  800260:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800267:	e8 fa 14 00 00       	call   801766 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800282:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  800295:	7e 28                	jle    8002bf <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800297:	89 44 24 10          	mov    %eax,0x10(%esp)
  80029b:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  8002a2:	00 
  8002a3:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002aa:	00 
  8002ab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b2:	00 
  8002b3:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002ba:	e8 a7 14 00 00       	call   801766 <_panic>
...
008002c7 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e8:	7e 28                	jle    800312 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ea:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002ee:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002f5:	00 
  8002f6:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002fd:	00 
  8002fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800305:	00 
  800306:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80030d:	e8 54 14 00 00       	call   801766 <_panic>
int
...
0080031a <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800320:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  800323:	bb 00 00 00 00       	mov    $0x0,%ebx
  800328:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80033b:	7e 28                	jle    800365 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80033d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800341:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800348:	00 
  800349:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800350:	00 
  800351:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800358:	00 
  800359:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800360:	e8 01 14 00 00       	call   801766 <_panic>
int
...
sys_ipc_recv(void *dstva)
{
  ...
  8003b0:	7e 28                	jle    8003da <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003b2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003b6:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003bd:	00 
  8003be:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003c5:	00 
  8003c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cd:	00 
  8003ce:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003d5:	e8 8c 13 00 00       	call   801766 <_panic>
...
sys_time_msec(void)
{
  ...
  8003ed:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003f2:	89 d1                	mov    %edx,%ecx
  8003f4:	89 d3                	mov    %edx,%ebx
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800422:	7e 28                	jle    80044c <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800424:	89 44 24 10          	mov    %eax,0x10(%esp)
  800428:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80042f:	00 
  800430:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800437:	00 
  800438:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043f:	00 
  800440:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800447:	e8 1a 13 00 00       	call   801766 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800475:	7e 28                	jle    80049f <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800477:	89 44 24 10          	mov    %eax,0x10(%esp)
  80047b:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800482:	00 
  800483:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80048a:	00 
  80048b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800492:	00 
  800493:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80049a:	e8 c7 12 00 00       	call   801766 <_panic>

int 
sys_e1000_recieve(char *data ,int *len)
{
	return (int) syscall (SYS_e1000_recieve,1,(uint32_t)data,(uint32_t)len,0,0,0);
  80049f:	83 c4 2c             	add    $0x2c,%esp
  8004a2:	5b                   	pop    %ebx
  8004a3:	5e                   	pop    %esi
  8004a4:	5f                   	pop    %edi
  8004a5:	5d                   	pop    %ebp
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 d3 fb ff ff       	call   800221 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 82 fa ff ff       	call   8001ce <sys_page_map>
  ...
  800782:	e8 47 fa ff ff       	call   8001ce <sys_page_map>
...
err:
  ...
  80079b:	e8 81 fa ff ff       	call   800221 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007ab:	e8 71 fa ff ff       	call   800221 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e3c:	e8 39 f3 ff ff       	call   80017a <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  8012a0:	e8 7c ef ff ff       	call   800221 <sys_page_unmap>
  ...
  8012b8:	e8 64 ef ff ff       	call   800221 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801354:	75 41                	jne    801397 <devpipe_write+0x6b>
			...
			sys_yield();
  801356:	e8 00 ee ff ff       	call   80015b <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013d4:	75 31                	jne    801407 <devpipe_read+0x63>
			...
			sys_yield();
  8013d6:	e8 80 ed ff ff       	call   80015b <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801447:	e8 2e ed ff ff       	call   80017a <sys_page_alloc>
  ...
  801481:	e8 f4 ec ff ff       	call   80017a <sys_page_alloc>
  ...
  8014b0:	e8 c5 ec ff ff       	call   80017a <sys_page_alloc>
  ...
  8014e9:	e8 e0 ec ff ff       	call   8001ce <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162d:	e8 7b ea ff ff       	call   8000ad <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801657:	eb 2a                	jmp    801683 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801659:	e8 fd ea ff ff       	call   80015b <sys_yield>
	int c;
  ...
  801660:	e8 66 ea ff ff       	call   8000cb <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80169f:	e8 09 ea ff ff       	call   8000ad <sys_cputs>
}
  8016a4:	c9                   	leave  
  8016a5:	c3                   	ret    
...
opencons(void)
{
  ...
  801738:	e8 3d ea ff ff       	call   80017a <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801777:	e8 c0 e9 ff ff       	call   80013c <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8017e9:	e8 bf e8 ff ff       	call   8000ad <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801852:	e8 56 e8 ff ff       	call   8000ad <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021f4:	e8 97 e1 ff ff       	call   800390 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80226e:	e8 fa e0 ff ff       	call   80036d <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802273:	eb 1c                	jmp    802291 <ipc_send+0x51>
	{
		sys_yield();
  802275:	e8 e1 de ff ff       	call   80015b <sys_yield>
  ...
  80228c:	e8 dc e0 ff ff       	call   80036d <sys_ipc_try_send>
	// LAB 4: Your code here.
