...
exit(void)
{
  ...
  800093:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800096:	e8 ef 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
  80009b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a2:	e8 3f 00 00 00       	call   8000e6 <sys_env_destroy>
}
  8000a7:	c9                   	leave  
  8000a8:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800106:	7e 28                	jle    800130 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800108:	89 44 24 10          	mov    %eax,0x10(%esp)
  80010c:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800113:	00 
  800114:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80011b:	00 
  80011c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800123:	00 
  800124:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80012b:	e8 36 16 00 00       	call   801766 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	7e 28                	jle    8001c2 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  80019a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80019e:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001a5:	00 
  8001a6:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8001ad:	00 
  8001ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b5:	00 
  8001b6:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8001bd:	e8 a4 15 00 00       	call   801766 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001eb:	7e 28                	jle    800215 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001ed:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001f1:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001f8:	00 
  8001f9:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800200:	00 
  800201:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800208:	00 
  800209:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800210:	e8 51 15 00 00       	call   801766 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023e:	7e 28                	jle    800268 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800240:	89 44 24 10          	mov    %eax,0x10(%esp)
  800244:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80024b:	00 
  80024c:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800253:	00 
  800254:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025b:	00 
  80025c:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800263:	e8 fe 14 00 00       	call   801766 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027e:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  800291:	7e 28                	jle    8002bb <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800293:	89 44 24 10          	mov    %eax,0x10(%esp)
  800297:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80029e:	00 
  80029f:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002a6:	00 
  8002a7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ae:	00 
  8002af:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8002b6:	e8 ab 14 00 00       	call   801766 <_panic>
...
008002c3 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d1:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8002e4:	7e 28                	jle    80030e <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002e6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002ea:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002f1:	00 
  8002f2:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8002f9:	00 
  8002fa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800301:	00 
  800302:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800309:	e8 58 14 00 00       	call   801766 <_panic>
int
...
00800316 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800324:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  800337:	7e 28                	jle    800361 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800339:	89 44 24 10          	mov    %eax,0x10(%esp)
  80033d:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800344:	00 
  800345:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  80034c:	00 
  80034d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800354:	00 
  800355:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  80035c:	e8 05 14 00 00       	call   801766 <_panic>
int
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80036e:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  80036f:	be 00 00 00 00       	mov    $0x0,%esi
  800374:	b8 0c 00 00 00       	mov    $0xc,%eax
  800379:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80037c:	8b 55 08             	mov    0x8(%ebp),%edx
  80037f:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800382:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80039a:	b8 0d 00 00 00       	mov    $0xd,%eax
  ...
  8003ac:	7e 28                	jle    8003d6 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003ae:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003b2:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003b9:	00 
  8003ba:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  8003c1:	00 
  8003c2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c9:	00 
  8003ca:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  8003d1:	e8 90 13 00 00       	call   801766 <_panic>
...
sys_time_msec(void)
{
  ...
  8003e9:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003ee:	89 d1                	mov    %edx,%ecx
  8003f0:	89 d3                	mov    %edx,%ebx
...
sys_e1000_transmit(char *data,int len)
{
  ...
  80041e:	7e 28                	jle    800448 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800420:	89 44 24 10          	mov    %eax,0x10(%esp)
  800424:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80042b:	00 
  80042c:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800433:	00 
  800434:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043b:	00 
  80043c:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800443:	e8 1e 13 00 00       	call   801766 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800471:	7e 28                	jle    80049b <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800473:	89 44 24 10          	mov    %eax,0x10(%esp)
  800477:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80047e:	00 
  80047f:	c7 44 24 08 ca 25 80 	movl   $0x8025ca,0x8(%esp)
  800486:	00 
  800487:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80048e:	00 
  80048f:	c7 04 24 e7 25 80 00 	movl   $0x8025e7,(%esp)
  800496:	e8 cb 12 00 00       	call   801766 <_panic>

int 
sys_e1000_recieve(char *data ,int *len)
{
	return (int) syscall (SYS_e1000_recieve,1,(uint32_t)data,(uint32_t)len,0,0,0);
  80049b:	83 c4 2c             	add    $0x2c,%esp
  80049e:	5b                   	pop    %ebx
  80049f:	5e                   	pop    %esi
  8004a0:	5f                   	pop    %edi
  8004a1:	5d                   	pop    %ebp
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80059f:	8b 04 95 74 26 80 00 	mov    0x802674(,%edx,4),%eax
  ...
  8005ba:	c7 04 24 f8 25 80 00 	movl   $0x8025f8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 cf fb ff ff       	call   80021d <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 7e fa ff ff       	call   8001ca <sys_page_map>
  ...
  800782:	e8 43 fa ff ff       	call   8001ca <sys_page_map>
...
err:
  ...
  80079b:	e8 7d fa ff ff       	call   80021d <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007ab:	e8 6d fa ff ff       	call   80021d <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80080f:	c7 04 24 39 26 80 00 	movl   $0x802639,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008e7:	c7 04 24 55 26 80 00 	movl   $0x802655,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009a0:	c7 04 24 18 26 80 00 	movl   $0x802618,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800aaf:	e8 ea 17 00 00       	call   80229e <ipc_find_env>
  ...
  800ad5:	e8 66 17 00 00       	call   802240 <ipc_send>
  ...
  800aed:	e8 e4 16 00 00       	call   8021d6 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800bbe:	8b 52 0c             	mov    0xc(%edx),%edx
  800bc1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c24:	c7 44 24 0c 88 26 80 	movl   $0x802688,0xc(%esp)
  800c2b:	00 
  800c2c:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  800c33:	00 
  800c34:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c3b:	00 
  800c3c:	c7 04 24 a4 26 80 00 	movl   $0x8026a4,(%esp)
  800c43:	e8 1e 0b 00 00       	call   801766 <_panic>
	assert(r <= PGSIZE);
  800c48:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c4d:	7e 24                	jle    800c73 <devfile_read+0x84>
  800c4f:	c7 44 24 0c af 26 80 	movl   $0x8026af,0xc(%esp)
  800c56:	00 
  800c57:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  800c5e:	00 
  800c5f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c66:	00 
  800c67:	c7 04 24 a4 26 80 00 	movl   $0x8026a4,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d36:	c7 44 24 04 bb 26 80 	movl   $0x8026bb,0x4(%esp)
  800d3d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  800d5d:	e8 74 15 00 00       	call   8022d6 <pageref>
...
alloc_sockfd(int sockid)
{
  ...
  800e3c:	e8 35 f3 ff ff       	call   800176 <sys_page_alloc>
...
nsipc(unsigned type)
{
  ...
  800f9c:	e8 fd 12 00 00       	call   80229e <ipc_find_env>
  ...
  800fc2:	e8 79 12 00 00       	call   802240 <ipc_send>
  ...
  800fde:	e8 f3 11 00 00       	call   8021d6 <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801157:	c7 44 24 0c c7 26 80 	movl   $0x8026c7,0xc(%esp)
  80115e:	00 
  80115f:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  801166:	00 
  801167:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80116e:	00 
  80116f:	c7 04 24 dc 26 80 00 	movl   $0x8026dc,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011b5:	c7 44 24 0c e8 26 80 	movl   $0x8026e8,0xc(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 08 8f 26 80 	movl   $0x80268f,0x8(%esp)
  8011c4:	00 
  8011c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011cc:	00 
  8011cd:	c7 04 24 dc 26 80 00 	movl   $0x8026dc,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801250:	c7 44 24 04 f4 26 80 	movl   $0x8026f4,0x4(%esp)
  801257:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  8012a0:	e8 78 ef ff ff       	call   80021d <sys_page_unmap>
  ...
  8012b8:	e8 60 ef ff ff       	call   80021d <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801316:	c7 04 24 fb 26 80 00 	movl   $0x8026fb,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801354:	75 41                	jne    801397 <devpipe_write+0x6b>
			...
			sys_yield();
  801356:	e8 fc ed ff ff       	call   800157 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013d4:	75 31                	jne    801407 <devpipe_read+0x63>
			...
			sys_yield();
  8013d6:	e8 7c ed ff ff       	call   800157 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801447:	e8 2a ed ff ff       	call   800176 <sys_page_alloc>
  ...
  801481:	e8 f0 ec ff ff       	call   800176 <sys_page_alloc>
  ...
  8014b0:	e8 c1 ec ff ff       	call   800176 <sys_page_alloc>
  ...
  8014e9:	e8 dc ec ff ff       	call   8001ca <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015d0:	c7 44 24 04 13 27 80 	movl   $0x802713,0x4(%esp)
  8015d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162d:	e8 77 ea ff ff       	call   8000a9 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801657:	eb 2a                	jmp    801683 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801659:	e8 f9 ea ff ff       	call   800157 <sys_yield>
	int c;
  ...
  801660:	e8 62 ea ff ff       	call   8000c7 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80169f:	e8 05 ea ff ff       	call   8000a9 <sys_cputs>
}
  8016a4:	c9                   	leave  
  8016a5:	c3                   	ret    
...
opencons(void)
{
  ...
  801738:	e8 39 ea ff ff       	call   800176 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801777:	e8 bc e9 ff ff       	call   800138 <sys_getenvid>
  ...
  801792:	c7 04 24 20 27 80 00 	movl   $0x802720,(%esp)
  ...
  8017a8:	e8 51 00 00 00       	call   8017fe <vcprintf>
	cprintf("\n");
  8017ad:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017e9:	e8 bb e8 ff ff       	call   8000a9 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801852:	e8 52 e8 ff ff       	call   8000a9 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8018ef:	e8 2c 0a 00 00       	call   802320 <__udivdi3>
  ...
  80194f:	e8 fc 0a 00 00       	call   802450 <__umoddi3>
  801954:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801958:	0f be 80 43 27 80 00 	movsbl 0x802743(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801a73:	ff 24 8d 80 28 80 00 	jmp    *0x802880(,%ecx,4)
  ...
  801b3f:	c7 44 24 08 a1 26 80 	movl   $0x8026a1,0x8(%esp)
  801b46:	00 
  ...
  801b71:	b8 54 27 80 00       	mov    $0x802754,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802294:	74 df                	je     802275 <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  8022bc:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8022c1:	8b 40 40             	mov    0x40(%eax),%eax
  8022c4:	eb 0e                	jmp    8022d4 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
