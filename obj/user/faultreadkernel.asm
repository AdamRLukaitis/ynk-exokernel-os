	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 f1 25 80 00 	movsbl 0x8025f1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 09 26 80 	movl   $0x802609,0x8(%esp)
  800426:	00 
  ...
  800471:	b8 02 26 80 00       	mov    $0x802602,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021c8:	e8 30 df ff ff       	call   8000fd <vcprintf>
	cprintf("\n");
  8021cd:	c7 04 24 40 2a 80 00 	movl   $0x802a40,(%esp)
