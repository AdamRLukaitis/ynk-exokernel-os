...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 c0 	movl   $0x8025c0,0x803000
  800040:	25 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 1b 01 00 00       	call   800163 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800055:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800058:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  80005f:	00 00 00 


	uint32_t env_id = ENVX(sys_getenvid());
  800062:	e8 dd 00 00 00       	call   800144 <sys_getenvid>
...
exit(void)
{
  ...
  80009f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a2:	e8 e3 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011f:	00 
  800120:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  800127:	00 
  800128:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012f:	00 
  800130:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  800137:	e8 2a 16 00 00       	call   801766 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b1:	00 
  8001b2:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  8001b9:	00 
  8001ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c1:	00 
  8001c2:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  8001c9:	e8 98 15 00 00       	call   801766 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800204:	00 
  800205:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  80020c:	00 
  80020d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800214:	00 
  800215:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  80021c:	e8 45 15 00 00       	call   801766 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  80026f:	e8 f2 14 00 00       	call   801766 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002aa:	00 
  8002ab:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  8002b2:	00 
  8002b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ba:	00 
  8002bb:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  8002c2:	e8 9f 14 00 00       	call   801766 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002fd:	00 
  8002fe:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  800305:	00 
  800306:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80030d:	00 
  80030e:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  800315:	e8 4c 14 00 00       	call   801766 <_panic>
int
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800350:	00 
  800351:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  800358:	00 
  800359:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800360:	00 
  800361:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  800368:	e8 f9 13 00 00       	call   801766 <_panic>
int
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c5:	00 
  8003c6:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  8003cd:	00 
  8003ce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d5:	00 
  8003d6:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  8003dd:	e8 84 13 00 00       	call   801766 <_panic>
...
sys_e1000_transmit(char *data,int len)
{
  ...
  80042a:	7e 28                	jle    800454 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80042c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800430:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800437:	00 
  800438:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  80043f:	00 
  800440:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800447:	00 
  800448:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  80044f:	e8 12 13 00 00       	call   801766 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  80047d:	7e 28                	jle    8004a7 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80047f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800483:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80048a:	00 
  80048b:	c7 44 24 08 cf 25 80 	movl   $0x8025cf,0x8(%esp)
  800492:	00 
  800493:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80049a:	00 
  80049b:	c7 04 24 ec 25 80 00 	movl   $0x8025ec,(%esp)
  8004a2:	e8 bf 12 00 00       	call   801766 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80059f:	8b 04 95 78 26 80 00 	mov    0x802678(,%edx,4),%eax
  ...
  8005ba:	c7 04 24 fc 25 80 00 	movl   $0x8025fc,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 db fb ff ff       	call   800229 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 8a fa ff ff       	call   8001d6 <sys_page_map>
  ...
  800782:	e8 4f fa ff ff       	call   8001d6 <sys_page_map>
...
err:
  ...
  80079b:	e8 89 fa ff ff       	call   800229 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007ab:	e8 79 fa ff ff       	call   800229 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80080f:	c7 04 24 3d 26 80 00 	movl   $0x80263d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008e7:	c7 04 24 59 26 80 00 	movl   $0x802659,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009a0:	c7 04 24 1c 26 80 00 	movl   $0x80261c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c24:	c7 44 24 0c 8c 26 80 	movl   $0x80268c,0xc(%esp)
  800c2b:	00 
  800c2c:	c7 44 24 08 93 26 80 	movl   $0x802693,0x8(%esp)
  800c33:	00 
  800c34:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c3b:	00 
  800c3c:	c7 04 24 a8 26 80 00 	movl   $0x8026a8,(%esp)
  800c43:	e8 1e 0b 00 00       	call   801766 <_panic>
	assert(r <= PGSIZE);
  800c48:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c4d:	7e 24                	jle    800c73 <devfile_read+0x84>
  800c4f:	c7 44 24 0c b3 26 80 	movl   $0x8026b3,0xc(%esp)
  800c56:	00 
  800c57:	c7 44 24 08 93 26 80 	movl   $0x802693,0x8(%esp)
  800c5e:	00 
  800c5f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c66:	00 
  800c67:	c7 04 24 a8 26 80 00 	movl   $0x8026a8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d36:	c7 44 24 04 bf 26 80 	movl   $0x8026bf,0x4(%esp)
  800d3d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800e3c:	e8 41 f3 ff ff       	call   800182 <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801157:	c7 44 24 0c cb 26 80 	movl   $0x8026cb,0xc(%esp)
  80115e:	00 
  80115f:	c7 44 24 08 93 26 80 	movl   $0x802693,0x8(%esp)
  801166:	00 
  801167:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80116e:	00 
  80116f:	c7 04 24 e0 26 80 00 	movl   $0x8026e0,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011b5:	c7 44 24 0c ec 26 80 	movl   $0x8026ec,0xc(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 08 93 26 80 	movl   $0x802693,0x8(%esp)
  8011c4:	00 
  8011c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011cc:	00 
  8011cd:	c7 04 24 e0 26 80 00 	movl   $0x8026e0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801250:	c7 44 24 04 f8 26 80 	movl   $0x8026f8,0x4(%esp)
  801257:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  8012a0:	e8 84 ef ff ff       	call   800229 <sys_page_unmap>
  ...
  8012b8:	e8 6c ef ff ff       	call   800229 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801316:	c7 04 24 ff 26 80 00 	movl   $0x8026ff,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801354:	75 41                	jne    801397 <devpipe_write+0x6b>
			...
			sys_yield();
  801356:	e8 08 ee ff ff       	call   800163 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013d4:	75 31                	jne    801407 <devpipe_read+0x63>
			...
			sys_yield();
  8013d6:	e8 88 ed ff ff       	call   800163 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801447:	e8 36 ed ff ff       	call   800182 <sys_page_alloc>
  ...
  801481:	e8 fc ec ff ff       	call   800182 <sys_page_alloc>
  ...
  8014b0:	e8 cd ec ff ff       	call   800182 <sys_page_alloc>
  ...
  8014e9:	e8 e8 ec ff ff       	call   8001d6 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015d0:	c7 44 24 04 17 27 80 	movl   $0x802717,0x4(%esp)
  8015d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80162d:	e8 83 ea ff ff       	call   8000b5 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801657:	eb 2a                	jmp    801683 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801659:	e8 05 eb ff ff       	call   800163 <sys_yield>
	int c;
  ...
  801660:	e8 6e ea ff ff       	call   8000d3 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80169f:	e8 11 ea ff ff       	call   8000b5 <sys_cputs>
}
  8016a4:	c9                   	leave  
  8016a5:	c3                   	ret    
...
opencons(void)
{
  ...
  801738:	e8 45 ea ff ff       	call   800182 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801777:	e8 c8 e9 ff ff       	call   800144 <sys_getenvid>
  ...
  801792:	c7 04 24 24 27 80 00 	movl   $0x802724,(%esp)
  ...
  8017a8:	e8 51 00 00 00       	call   8017fe <vcprintf>
	cprintf("\n");
  8017ad:	c7 04 24 10 27 80 00 	movl   $0x802710,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017e9:	e8 c7 e8 ff ff       	call   8000b5 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801852:	e8 5e e8 ff ff       	call   8000b5 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801958:	0f be 80 47 27 80 00 	movsbl 0x802747(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801b1f:	c7 44 24 08 5f 27 80 	movl   $0x80275f,0x8(%esp)
  801b26:	00 
  ...
  801b3f:	c7 44 24 08 a5 26 80 	movl   $0x8026a5,0x8(%esp)
  801b46:	00 
  ...
  801b71:	b8 58 27 80 00       	mov    $0x802758,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021f4:	e8 9f e1 ff ff       	call   800398 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80226e:	e8 02 e1 ff ff       	call   800375 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802273:	eb 1c                	jmp    802291 <ipc_send+0x51>
	{
		sys_yield();
  802275:	e8 e9 de ff ff       	call   800163 <sys_yield>
  ...
  80228c:	e8 e4 e0 ff ff       	call   800375 <sys_ipc_try_send>
	// LAB 4: Your code here.
