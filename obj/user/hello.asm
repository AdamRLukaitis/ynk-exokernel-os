...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 c0 25 80 00 	movl   $0x8025c0,(%esp)
  ...
  800051:	c7 04 24 ce 25 80 00 	movl   $0x8025ce,(%esp)
  800058:	e8 10 01 00 00       	call   80016d <cprintf>
}
  80005d:	c9                   	leave  
  80005e:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006a:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  80006d:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  800074:	00 00 00 
...
exit(void)
{
  ...
  8000b4:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b7:	e8 fe 0f 00 00       	call   8010ba <close_all>
	sys_env_destroy(0);
  8000bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000c3:	e8 5b 0a 00 00       	call   800b23 <sys_env_destroy>
}
  8000c8:	c9                   	leave  
  8000c9:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800141:	c7 04 24 ca 00 80 00 	movl   $0x8000ca,(%esp)
  800148:	e8 b1 01 00 00       	call   8002fe <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800160:	e8 81 09 00 00       	call   800ae6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	0f be 80 ef 25 80 00 	movsbl 0x8025ef(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800383:	ff 24 8d 40 27 80 00 	jmp    *0x802740(,%ecx,4)
  ...
  80044f:	c7 44 24 08 d5 29 80 	movl   $0x8029d5,0x8(%esp)
  800456:	00 
  ...
  800481:	b8 00 26 80 00       	mov    $0x802600,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b50:	00 
  800b51:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800b58:	00 
  800b59:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b60:	00 
  800b61:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be2:	00 
  800be3:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800bea:	00 
  800beb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf2:	00 
  800bf3:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c35:	00 
  800c36:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800c3d:	00 
  800c3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c45:	00 
  800c46:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdb:	00 
  800cdc:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800ce3:	00 
  800ce4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ceb:	00 
  800cec:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d2e:	00 
  800d2f:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800d36:	00 
  800d37:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3e:	00 
  800d3f:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800df6:	00 
  800df7:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800dfe:	00 
  800dff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e06:	00 
  800e07:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800e68:	00 
  800e69:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800e70:	00 
  800e71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e78:	00 
  800e79:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800ebb:	00 
  800ebc:	c7 44 24 08 ff 28 80 	movl   $0x8028ff,0x8(%esp)
  800ec3:	00 
  800ec4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ecb:	00 
  800ecc:	c7 04 24 1c 29 80 00 	movl   $0x80291c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fcf:	8b 04 95 a8 29 80 00 	mov    0x8029a8(,%edx,4),%eax
  ...
  800fea:	c7 04 24 2c 29 80 00 	movl   $0x80292c,(%esp)
  800ff1:	e8 77 f1 ff ff       	call   80016d <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80123f:	c7 04 24 6d 29 80 00 	movl   $0x80296d,(%esp)
  801246:	e8 22 ef ff ff       	call   80016d <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801317:	c7 04 24 89 29 80 00 	movl   $0x802989,(%esp)
  80131e:	e8 4a ee ff ff       	call   80016d <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013d0:	c7 04 24 4c 29 80 00 	movl   $0x80294c,(%esp)
  8013d7:	e8 91 ed ff ff       	call   80016d <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801654:	c7 44 24 0c bc 29 80 	movl   $0x8029bc,0xc(%esp)
  80165b:	00 
  80165c:	c7 44 24 08 c3 29 80 	movl   $0x8029c3,0x8(%esp)
  801663:	00 
  801664:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80166b:	00 
  80166c:	c7 04 24 d8 29 80 00 	movl   $0x8029d8,(%esp)
  801673:	e8 1e 0b 00 00       	call   802196 <_panic>
	assert(r <= PGSIZE);
  801678:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80167d:	7e 24                	jle    8016a3 <devfile_read+0x84>
  80167f:	c7 44 24 0c e3 29 80 	movl   $0x8029e3,0xc(%esp)
  801686:	00 
  801687:	c7 44 24 08 c3 29 80 	movl   $0x8029c3,0x8(%esp)
  80168e:	00 
  80168f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801696:	00 
  801697:	c7 04 24 d8 29 80 00 	movl   $0x8029d8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801766:	c7 44 24 04 ef 29 80 	movl   $0x8029ef,0x4(%esp)
  80176d:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b87:	c7 44 24 0c fb 29 80 	movl   $0x8029fb,0xc(%esp)
  801b8e:	00 
  801b8f:	c7 44 24 08 c3 29 80 	movl   $0x8029c3,0x8(%esp)
  801b96:	00 
  801b97:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801b9e:	00 
  801b9f:	c7 04 24 10 2a 80 00 	movl   $0x802a10,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801be5:	c7 44 24 0c 1c 2a 80 	movl   $0x802a1c,0xc(%esp)
  801bec:	00 
  801bed:	c7 44 24 08 c3 29 80 	movl   $0x8029c3,0x8(%esp)
  801bf4:	00 
  801bf5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801bfc:	00 
  801bfd:	c7 04 24 10 2a 80 00 	movl   $0x802a10,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c80:	c7 44 24 04 28 2a 80 	movl   $0x802a28,0x4(%esp)
  801c87:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d46:	c7 04 24 2f 2a 80 00 	movl   $0x802a2f,(%esp)
  801d4d:	e8 1b e4 ff ff       	call   80016d <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802000:	c7 44 24 04 47 2a 80 	movl   $0x802a47,0x4(%esp)
  802007:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021c2:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
  8021c9:	e8 9f df ff ff       	call   80016d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8021ce:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8021d2:	8b 45 10             	mov    0x10(%ebp),%eax
  8021d5:	89 04 24             	mov    %eax,(%esp)
  8021d8:	e8 2f df ff ff       	call   80010c <vcprintf>
	cprintf("\n");
  8021dd:	c7 04 24 40 2a 80 00 	movl   $0x802a40,(%esp)
  8021e4:	e8 84 df ff ff       	call   80016d <cprintf>
