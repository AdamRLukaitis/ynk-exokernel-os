...
umain(int argc, char **argv)
{
  ...
  800049:	e8 10 01 00 00       	call   80015e <cprintf>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
exit(void)
{
  ...
  8000a5:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a8:	e8 fd 0f 00 00       	call   8010aa <close_all>
	sys_env_destroy(0);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	e8 2c 21 00 00       	call   802320 <__udivdi3>
  ...
  80024f:	e8 fc 21 00 00       	call   802450 <__umoddi3>
  800254:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800258:	0f be 80 e8 25 80 00 	movsbl 0x8025e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 8d 20 27 80 00 	jmp    *0x802720(,%ecx,4)
  ...
  80043f:	c7 44 24 08 b5 29 80 	movl   $0x8029b5,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 f9 25 80 00       	mov    $0x8025f9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c78:	00 
  800c79:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ccb:	00 
  800ccc:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d1e:	00 
  800d1f:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d71:	00 
  800d72:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d79:	00 
  800d7a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d81:	00 
  800d82:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de6:	00 
  800de7:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800dee:	00 
  800def:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df6:	00 
  800df7:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800e4b:	7e 28                	jle    800e75 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800e4d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800e51:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800e58:	00 
  800e59:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800e60:	00 
  800e61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e68:	00 
  800e69:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800e9e:	7e 28                	jle    800ec8 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800ea0:	89 44 24 10          	mov    %eax,0x10(%esp)
  800ea4:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800eab:	00 
  800eac:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800eb3:	00 
  800eb4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ebb:	00 
  800ebc:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fbf:	8b 04 95 88 29 80 00 	mov    0x802988(,%edx,4),%eax
  ...
  800fda:	c7 04 24 0c 29 80 00 	movl   $0x80290c,(%esp)
  800fe1:	e8 78 f1 ff ff       	call   80015e <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80122f:	c7 04 24 4d 29 80 00 	movl   $0x80294d,(%esp)
  801236:	e8 23 ef ff ff       	call   80015e <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801307:	c7 04 24 69 29 80 00 	movl   $0x802969,(%esp)
  80130e:	e8 4b ee ff ff       	call   80015e <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013c0:	c7 04 24 2c 29 80 00 	movl   $0x80292c,(%esp)
  8013c7:	e8 92 ed ff ff       	call   80015e <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
fsipc(unsigned type, void *dstva)
{
  ...
  8014cf:	e8 d0 0d 00 00       	call   8022a4 <ipc_find_env>
  ...
  8014f5:	e8 4c 0d 00 00       	call   802246 <ipc_send>
  ...
  80150d:	e8 ca 0c 00 00       	call   8021dc <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8015e1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801644:	c7 44 24 0c 9c 29 80 	movl   $0x80299c,0xc(%esp)
  80164b:	00 
  80164c:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801653:	00 
  801654:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80165b:	00 
  80165c:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
  801663:	e8 1e 0b 00 00       	call   802186 <_panic>
	assert(r <= PGSIZE);
  801668:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80166d:	7e 24                	jle    801693 <devfile_read+0x84>
  80166f:	c7 44 24 0c c3 29 80 	movl   $0x8029c3,0xc(%esp)
  801676:	00 
  801677:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  80167e:	00 
  80167f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801686:	00 
  801687:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801756:	c7 44 24 04 cf 29 80 	movl   $0x8029cf,0x4(%esp)
  80175d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  80177d:	e8 5a 0b 00 00       	call   8022dc <pageref>
...
nsipc(unsigned type)
{
  ...
  8019bc:	e8 e3 08 00 00       	call   8022a4 <ipc_find_env>
  ...
  8019e2:	e8 5f 08 00 00       	call   802246 <ipc_send>
  ...
  8019fe:	e8 d9 07 00 00       	call   8021dc <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b77:	c7 44 24 0c db 29 80 	movl   $0x8029db,0xc(%esp)
  801b7e:	00 
  801b7f:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801b86:	00 
  801b87:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801b8e:	00 
  801b8f:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801bd5:	c7 44 24 0c fc 29 80 	movl   $0x8029fc,0xc(%esp)
  801bdc:	00 
  801bdd:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801be4:	00 
  801be5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801bec:	00 
  801bed:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c70:	c7 44 24 04 08 2a 80 	movl   $0x802a08,0x4(%esp)
  801c77:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d36:	c7 04 24 0f 2a 80 00 	movl   $0x802a0f,(%esp)
  801d3d:	e8 1c e4 ff ff       	call   80015e <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ff0:	c7 44 24 04 27 2a 80 	movl   $0x802a27,0x4(%esp)
  801ff7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021b2:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
  8021b9:	e8 a0 df ff ff       	call   80015e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8021be:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8021c2:	8b 45 10             	mov    0x10(%ebp),%eax
  8021c5:	89 04 24             	mov    %eax,(%esp)
  8021c8:	e8 30 df ff ff       	call   8000fd <vcprintf>
	cprintf("\n");
  8021cd:	c7 04 24 dc 25 80 00 	movl   $0x8025dc,(%esp)
  8021d4:	e8 85 df ff ff       	call   80015e <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021e4:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  8021ed:	85 c0                	test   %eax,%eax
		pg = (void*)0xfffffffff;
  8021ef:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  8021f4:	0f 44 c2             	cmove  %edx,%eax
	if((pg!=NULL))
	{
		if((return_code=sys_ipc_recv(pg))==0)
  8021f7:	89 04 24             	mov    %eax,(%esp)
  8021fa:	e8 ba eb ff ff       	call   800db9 <sys_ipc_recv>
  8021ff:	85 c0                	test   %eax,%eax
  802201:	75 1e                	jne    802221 <ipc_recv+0x45>
		{
			if(from_env_store!=NULL)
  802203:	85 db                	test   %ebx,%ebx
  802205:	74 0a                	je     802211 <ipc_recv+0x35>
			*from_env_store = thisenv->env_ipc_from;
  802207:	a1 08 40 80 00       	mov    0x804008,%eax
  80220c:	8b 40 74             	mov    0x74(%eax),%eax
  80220f:	89 03                	mov    %eax,(%ebx)
			if(perm_store!=NULL)
  802211:	85 f6                	test   %esi,%esi
  802213:	74 22                	je     802237 <ipc_recv+0x5b>
			*perm_store = thisenv->env_ipc_perm;
  802215:	a1 08 40 80 00       	mov    0x804008,%eax
  80221a:	8b 40 78             	mov    0x78(%eax),%eax
  80221d:	89 06                	mov    %eax,(%esi)
  80221f:	eb 16                	jmp    802237 <ipc_recv+0x5b>
		}
		else
		{
			if(perm_store!=NULL)
  802221:	85 f6                	test   %esi,%esi
  802223:	74 06                	je     80222b <ipc_recv+0x4f>
				*perm_store = 0;
  802225:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
			if(from_env_store!=NULL)
  80222b:	85 db                	test   %ebx,%ebx
  80222d:	74 10                	je     80223f <ipc_recv+0x63>
				*from_env_store=0;
  80222f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  802235:	eb 08                	jmp    80223f <ipc_recv+0x63>
			return return_code;
		}
...
return thisenv->env_ipc_value;
  ...
  80223c:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802292:	e8 ff ea ff ff       	call   800d96 <sys_ipc_try_send>
	...
	int return_code = sys_ipc_try_send(to_env,val,pg,perm);
	while(return_code == -E_IPC_NOT_RECV)
  802297:	83 f8 f9             	cmp    $0xfffffff9,%eax
  80229a:	74 df                	je     80227b <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  8022af:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8022b2:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8022b8:	8b 52 50             	mov    0x50(%edx),%edx
  8022bb:	39 ca                	cmp    %ecx,%edx
  8022bd:	75 0d                	jne    8022cc <ipc_find_env+0x28>
			return envs[i].env_id;
  8022bf:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8022c2:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8022c7:	8b 40 40             	mov    0x40(%eax),%eax
  8022ca:	eb 0e                	jmp    8022da <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  8022cc:	83 c0 01             	add    $0x1,%eax
  8022cf:	3d 00 04 00 00       	cmp    $0x400,%eax
  8022d4:	75 d9                	jne    8022af <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8022d6:	66 b8 00 00          	mov    $0x0,%ax
}
  8022da:	5d                   	pop    %ebp
  8022db:	c3                   	ret    
...
pageref(void *v)
{
  ...
  8022e4:	c1 e8 16             	shr    $0x16,%eax
  8022e7:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  8022f3:	f6 c1 01             	test   $0x1,%cl
  8022f6:	74 1d                	je     802315 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  802305:	74 0e                	je     802315 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  802307:	c1 ea 0c             	shr    $0xc,%edx
  80230a:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  802311:	ef 
  802312:	0f b7 c0             	movzwl %ax,%eax
}
  802315:	5d                   	pop    %ebp
  802316:	c3                   	ret    
