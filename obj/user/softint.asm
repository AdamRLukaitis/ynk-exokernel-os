...
libmain(int argc, char **argv)
{
  ...
  800045:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800048:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  80004f:	00 00 00 


	uint32_t env_id = ENVX(sys_getenvid());
  800052:	e8 dd 00 00 00       	call   800134 <sys_getenvid>
  ...
  80006f:	a3 00 30 80 00       	mov    %eax,0x803000
	...
	umain(argc, argv);
  800074:	89 74 24 04          	mov    %esi,0x4(%esp)
  800078:	89 1c 24             	mov    %ebx,(%esp)
...
exit(void)
{
  ...
  80008f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800092:	e8 e3 05 00 00       	call   80067a <close_all>
	sys_env_destroy(0);
  800097:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80009e:	e8 3f 00 00 00       	call   8000e2 <sys_env_destroy>
}
  8000a3:	c9                   	leave  
  8000a4:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800102:	7e 28                	jle    80012c <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800104:	89 44 24 10          	mov    %eax,0x10(%esp)
  800108:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80010f:	00 
  800110:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800117:	00 
  800118:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011f:	00 
  800120:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800127:	e8 2a 16 00 00       	call   801756 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800194:	7e 28                	jle    8001be <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  800196:	89 44 24 10          	mov    %eax,0x10(%esp)
  80019a:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001a1:	00 
  8001a2:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8001a9:	00 
  8001aa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b1:	00 
  8001b2:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8001b9:	e8 98 15 00 00       	call   801756 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001e7:	7e 28                	jle    800211 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001e9:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ed:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001f4:	00 
  8001f5:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8001fc:	00 
  8001fd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800204:	00 
  800205:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80020c:	e8 45 15 00 00       	call   801756 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023a:	7e 28                	jle    800264 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80023c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800240:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800247:	00 
  800248:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  80024f:	00 
  800250:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800257:	00 
  800258:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80025f:	e8 f2 14 00 00       	call   801756 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028d:	7e 28                	jle    8002b7 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80028f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800293:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80029a:	00 
  80029b:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8002a2:	00 
  8002a3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002aa:	00 
  8002ab:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8002b2:	e8 9f 14 00 00       	call   801756 <_panic>
...
008002bf <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e0:	7e 28                	jle    80030a <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002e2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002e6:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002ed:	00 
  8002ee:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8002f5:	00 
  8002f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fd:	00 
  8002fe:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800305:	e8 4c 14 00 00       	call   801756 <_panic>
int
...
00800312 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800320:	b8 0a 00 00 00       	mov    $0xa,%eax
  800325:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800328:	8b 55 08             	mov    0x8(%ebp),%edx
  80032b:	89 df                	mov    %ebx,%edi
  80032d:	89 de                	mov    %ebx,%esi
  ...
  800333:	7e 28                	jle    80035d <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800335:	89 44 24 10          	mov    %eax,0x10(%esp)
  800339:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800340:	00 
  800341:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800348:	00 
  800349:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800350:	00 
  800351:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800358:	e8 f9 13 00 00       	call   801756 <_panic>
int
...
sys_ipc_recv(void *dstva)
{
  ...
  800396:	b8 0d 00 00 00       	mov    $0xd,%eax
  ...
  8003a8:	7e 28                	jle    8003d2 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003aa:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003ae:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003b5:	00 
  8003b6:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  8003bd:	00 
  8003be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c5:	00 
  8003c6:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  8003cd:	e8 84 13 00 00       	call   801756 <_panic>
...
sys_time_msec(void)
{
  ...
  8003e5:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003ea:	89 d1                	mov    %edx,%ecx
  8003ec:	89 d3                	mov    %edx,%ebx
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800407:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  80041a:	7e 28                	jle    800444 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800420:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800427:	00 
  800428:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  80042f:	00 
  800430:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800437:	00 
  800438:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  80043f:	e8 12 13 00 00       	call   801756 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800452:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  800455:	bb 00 00 00 00       	mov    $0x0,%ebx
  80045a:	b8 10 00 00 00       	mov    $0x10,%eax
  80045f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800462:	8b 55 08             	mov    0x8(%ebp),%edx
  800465:	89 df                	mov    %ebx,%edi
  ...
  80046d:	7e 28                	jle    800497 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80046f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800473:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80047a:	00 
  80047b:	c7 44 24 08 aa 25 80 	movl   $0x8025aa,0x8(%esp)
  800482:	00 
  800483:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80048a:	00 
  80048b:	c7 04 24 c7 25 80 00 	movl   $0x8025c7,(%esp)
  800492:	e8 bf 12 00 00       	call   801756 <_panic>

int 
sys_e1000_recieve(char *data ,int *len)
{
	return (int) syscall (SYS_e1000_recieve,1,(uint32_t)data,(uint32_t)len,0,0,0);
  800497:	83 c4 2c             	add    $0x2c,%esp
  80049a:	5b                   	pop    %ebx
  80049b:	5e                   	pop    %esi
  80049c:	5f                   	pop    %edi
  80049d:	5d                   	pop    %ebp
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80058f:	8b 04 95 54 26 80 00 	mov    0x802654(,%edx,4),%eax
  ...
  8005aa:	c7 04 24 d8 25 80 00 	movl   $0x8025d8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800639:	e8 db fb ff ff       	call   800219 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800737:	e8 8a fa ff ff       	call   8001c6 <sys_page_map>
  ...
  800772:	e8 4f fa ff ff       	call   8001c6 <sys_page_map>
...
err:
  ...
  80078b:	e8 89 fa ff ff       	call   800219 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800790:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800794:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80079b:	e8 79 fa ff ff       	call   800219 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8007ff:	c7 04 24 19 26 80 00 	movl   $0x802619,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008d7:	c7 04 24 35 26 80 00 	movl   $0x802635,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800990:	c7 04 24 f8 25 80 00 	movl   $0x8025f8,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a9f:	e8 ea 17 00 00       	call   80228e <ipc_find_env>
  ...
  800ac5:	e8 66 17 00 00       	call   802230 <ipc_send>
  ...
  800add:	e8 e4 16 00 00       	call   8021c6 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800bae:	8b 52 0c             	mov    0xc(%edx),%edx
  800bb1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c14:	c7 44 24 0c 68 26 80 	movl   $0x802668,0xc(%esp)
  800c1b:	00 
  800c1c:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  800c23:	00 
  800c24:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800c2b:	00 
  800c2c:	c7 04 24 84 26 80 00 	movl   $0x802684,(%esp)
  800c33:	e8 1e 0b 00 00       	call   801756 <_panic>
	assert(r <= PGSIZE);
  800c38:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c3d:	7e 24                	jle    800c63 <devfile_read+0x84>
  800c3f:	c7 44 24 0c 8f 26 80 	movl   $0x80268f,0xc(%esp)
  800c46:	00 
  800c47:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  800c4e:	00 
  800c4f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800c56:	00 
  800c57:	c7 04 24 84 26 80 00 	movl   $0x802684,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800d26:	c7 44 24 04 9b 26 80 	movl   $0x80269b,0x4(%esp)
  800d2d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  800d4d:	e8 74 15 00 00       	call   8022c6 <pageref>
...
alloc_sockfd(int sockid)
{
  ...
  800e2c:	e8 41 f3 ff ff       	call   800172 <sys_page_alloc>
...
nsipc(unsigned type)
{
  ...
  800f8c:	e8 fd 12 00 00       	call   80228e <ipc_find_env>
  ...
  800fb2:	e8 79 12 00 00       	call   802230 <ipc_send>
  ...
  800fce:	e8 f3 11 00 00       	call   8021c6 <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801147:	c7 44 24 0c a7 26 80 	movl   $0x8026a7,0xc(%esp)
  80114e:	00 
  80114f:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  801156:	00 
  801157:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80115e:	00 
  80115f:	c7 04 24 bc 26 80 00 	movl   $0x8026bc,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011a5:	c7 44 24 0c c8 26 80 	movl   $0x8026c8,0xc(%esp)
  8011ac:	00 
  8011ad:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  8011b4:	00 
  8011b5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8011bc:	00 
  8011bd:	c7 04 24 bc 26 80 00 	movl   $0x8026bc,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801240:	c7 44 24 04 d4 26 80 	movl   $0x8026d4,0x4(%esp)
  801247:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  801290:	e8 84 ef ff ff       	call   800219 <sys_page_unmap>
  ...
  8012a8:	e8 6c ef ff ff       	call   800219 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801306:	c7 04 24 db 26 80 00 	movl   $0x8026db,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801344:	75 41                	jne    801387 <devpipe_write+0x6b>
			...
			sys_yield();
  801346:	e8 08 ee ff ff       	call   800153 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8013c4:	75 31                	jne    8013f7 <devpipe_read+0x63>
			...
			sys_yield();
  8013c6:	e8 88 ed ff ff       	call   800153 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801437:	e8 36 ed ff ff       	call   800172 <sys_page_alloc>
  ...
  801471:	e8 fc ec ff ff       	call   800172 <sys_page_alloc>
  ...
  8014a0:	e8 cd ec ff ff       	call   800172 <sys_page_alloc>
  ...
  8014d9:	e8 e8 ec ff ff       	call   8001c6 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015c0:	c7 44 24 04 f3 26 80 	movl   $0x8026f3,0x4(%esp)
  8015c7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80161d:	e8 83 ea ff ff       	call   8000a5 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801647:	eb 2a                	jmp    801673 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801649:	e8 05 eb ff ff       	call   800153 <sys_yield>
	int c;
  ...
  801650:	e8 6e ea ff ff       	call   8000c3 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80168f:	e8 11 ea ff ff       	call   8000a5 <sys_cputs>
}
  801694:	c9                   	leave  
  801695:	c3                   	ret    
...
opencons(void)
{
  ...
  801728:	e8 45 ea ff ff       	call   800172 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801767:	e8 c8 e9 ff ff       	call   800134 <sys_getenvid>
  ...
  801782:	c7 04 24 00 27 80 00 	movl   $0x802700,(%esp)
  ...
  801798:	e8 51 00 00 00       	call   8017ee <vcprintf>
	cprintf("\n");
  80179d:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8017d9:	e8 c7 e8 ff ff       	call   8000a5 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801842:	e8 5e e8 ff ff       	call   8000a5 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8018df:	e8 2c 0a 00 00       	call   802310 <__udivdi3>
  ...
  80193f:	e8 fc 0a 00 00       	call   802440 <__umoddi3>
  801944:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801948:	0f be 80 23 27 80 00 	movsbl 0x802723(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801a63:	ff 24 8d 60 28 80 00 	jmp    *0x802860(,%ecx,4)
  ...
  801b2f:	c7 44 24 08 81 26 80 	movl   $0x802681,0x8(%esp)
  801b36:	00 
  ...
  801b61:	b8 34 27 80 00       	mov    $0x802734,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021ce:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  8021d7:	85 c0                	test   %eax,%eax
		pg = (void*)0xfffffffff;
  8021d9:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  8021de:	0f 44 c2             	cmove  %edx,%eax
	if((pg!=NULL))
	{
		if((return_code=sys_ipc_recv(pg))==0)
  8021e1:	89 04 24             	mov    %eax,(%esp)
  8021e4:	e8 9f e1 ff ff       	call   800388 <sys_ipc_recv>
  8021e9:	85 c0                	test   %eax,%eax
  8021eb:	75 1e                	jne    80220b <ipc_recv+0x45>
		{
			if(from_env_store!=NULL)
  8021ed:	85 db                	test   %ebx,%ebx
  8021ef:	74 0a                	je     8021fb <ipc_recv+0x35>
			*from_env_store = thisenv->env_ipc_from;
  8021f1:	a1 08 40 80 00       	mov    0x804008,%eax
  8021f6:	8b 40 74             	mov    0x74(%eax),%eax
  8021f9:	89 03                	mov    %eax,(%ebx)
			if(perm_store!=NULL)
  8021fb:	85 f6                	test   %esi,%esi
  8021fd:	74 22                	je     802221 <ipc_recv+0x5b>
			*perm_store = thisenv->env_ipc_perm;
  8021ff:	a1 08 40 80 00       	mov    0x804008,%eax
  802204:	8b 40 78             	mov    0x78(%eax),%eax
  802207:	89 06                	mov    %eax,(%esi)
  802209:	eb 16                	jmp    802221 <ipc_recv+0x5b>
		}
		else
		{
			if(perm_store!=NULL)
  80220b:	85 f6                	test   %esi,%esi
  80220d:	74 06                	je     802215 <ipc_recv+0x4f>
				*perm_store = 0;
  80220f:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
			if(from_env_store!=NULL)
  802215:	85 db                	test   %ebx,%ebx
  802217:	74 10                	je     802229 <ipc_recv+0x63>
				*from_env_store=0;
  802219:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  80221f:	eb 08                	jmp    802229 <ipc_recv+0x63>
			return return_code;
		}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802234:	56                   	push   %esi
  802235:	53                   	push   %ebx
  802236:	83 ec 1c             	sub    $0x1c,%esp
  802239:	8b 75 0c             	mov    0xc(%ebp),%esi
  80223c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80223f:	8b 7d 14             	mov    0x14(%ebp),%edi
	// LAB 4: Your code here.

	if(pg ==NULL)
  802242:	85 db                	test   %ebx,%ebx
		pg = (void*)KERNBASE;
  802244:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  802249:	0f 44 d8             	cmove  %eax,%ebx
	int return_code = sys_ipc_try_send(to_env,val,pg,perm);
  80224c:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802250:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  802254:	89 74 24 04          	mov    %esi,0x4(%esp)
  802258:	8b 45 08             	mov    0x8(%ebp),%eax
  80225b:	89 04 24             	mov    %eax,(%esp)
  80225e:	e8 02 e1 ff ff       	call   800365 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802263:	eb 1c                	jmp    802281 <ipc_send+0x51>
	{
		sys_yield();
  802265:	e8 e9 de ff ff       	call   800153 <sys_yield>
		return_code = sys_ipc_try_send(to_env,val,pg,perm);
  80226a:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  ...
  80227c:	e8 e4 e0 ff ff       	call   800365 <sys_ipc_try_send>
	// LAB 4: Your code here.
  ...
  802284:	74 df                	je     802265 <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  802299:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80229c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8022a2:	8b 52 50             	mov    0x50(%edx),%edx
  8022a5:	39 ca                	cmp    %ecx,%edx
  8022a7:	75 0d                	jne    8022b6 <ipc_find_env+0x28>
			return envs[i].env_id;
  8022a9:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8022ac:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8022b1:	8b 40 40             	mov    0x40(%eax),%eax
  8022b4:	eb 0e                	jmp    8022c4 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8022be:	75 d9                	jne    802299 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8022c0:	66 b8 00 00          	mov    $0x0,%ax
}
  8022c4:	5d                   	pop    %ebp
  8022c5:	c3                   	ret    
