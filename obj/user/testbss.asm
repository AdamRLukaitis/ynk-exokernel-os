...
umain(int argc, char **argv)
{
  ...
  800040:	e8 1d 02 00 00       	call   800262 <cprintf>
  ...
  800058:	c7 44 24 08 db 26 80 	movl   $0x8026db,0x8(%esp)
  80005f:	00 
  800060:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800067:	00 
  800068:	c7 04 24 f8 26 80 00 	movl   $0x8026f8,(%esp)
  80006f:	e8 f5 00 00 00       	call   800169 <_panic>
umain(int argc, char **argv)
{
	int i;
  ...
  8000a6:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 f8 26 80 00 	movl   $0x8026f8,(%esp)
  8000bd:	e8 a7 00 00 00       	call   800169 <_panic>
	for (i = 0; i < ARRAYSIZE; i++)
		if (bigarray[i] != 0)
			panic("bigarray[%d] isn't cleared!\n", i);
	for (i = 0; i < ARRAYSIZE; i++)
  ...
  8000cc:	c7 04 24 a8 26 80 00 	movl   $0x8026a8,(%esp)
  8000d3:	e8 8a 01 00 00       	call   800262 <cprintf>
	bigarray[ARRAYSIZE+1024] = 0;
  8000d8:	c7 05 20 50 c0 00 00 	movl   $0x0,0xc05020
  8000df:	00 00 00 
	panic("SHOULD HAVE TRAPPED!!!");
  8000e2:	c7 44 24 08 07 27 80 	movl   $0x802707,0x8(%esp)
  8000e9:	00 
  8000ea:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8000f1:	00 
  8000f2:	c7 04 24 f8 26 80 00 	movl   $0x8026f8,(%esp)
  8000f9:	e8 6b 00 00 00       	call   800169 <_panic>
...
libmain(int argc, char **argv)
{
  ...
  800109:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  80010c:	c7 05 20 40 c0 00 00 	movl   $0x0,0xc04020
  800113:	00 00 00 
  ...
  800128:	a3 20 40 c0 00       	mov    %eax,0xc04020
...
exit(void)
{
  ...
  800153:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800156:	e8 4f 10 00 00       	call   8011aa <close_all>
	sys_env_destroy(0);
  80015b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800162:	e8 ac 0a 00 00       	call   800c13 <sys_env_destroy>
}
  800167:	c9                   	leave  
  800168:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800174:	8b 35 00 30 80 00    	mov    0x803000,%esi
  80017a:	e8 e6 0a 00 00       	call   800c65 <sys_getenvid>
  ...
  800195:	c7 04 24 28 27 80 00 	movl   $0x802728,(%esp)
  ...
  8001ab:	e8 51 00 00 00       	call   800201 <vcprintf>
	cprintf("\n");
  8001b0:	c7 04 24 f6 26 80 00 	movl   $0x8026f6,(%esp)
  8001b7:	e8 a6 00 00 00       	call   800262 <cprintf>
	...
	while (1)
		asm volatile("int3");
  8001bc:	cc                   	int3   
  8001bd:	eb fd                	jmp    8001bc <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001ec:	e8 e5 09 00 00       	call   800bd6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80023d:	e8 ac 01 00 00       	call   8003ee <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800255:	e8 7c 09 00 00       	call   800bd6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 dc 20 00 00       	call   8023d0 <__udivdi3>
  ...
  80034f:	e8 ac 21 00 00       	call   802500 <__umoddi3>
  800354:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800358:	0f be 80 4b 27 80 00 	movsbl 0x80274b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800473:	ff 24 8d 80 28 80 00 	jmp    *0x802880(,%ecx,4)
  ...
  80053f:	c7 44 24 08 19 2b 80 	movl   $0x802b19,0x8(%esp)
  800546:	00 
  ...
  800571:	b8 5c 27 80 00       	mov    $0x80275c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800c58:	e8 0c f5 ff ff       	call   800169 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cd2:	00 
  800cd3:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800cda:	00 
  800cdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce2:	00 
  800ce3:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800cea:	e8 7a f4 ff ff       	call   800169 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	00 
  800d26:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800d2d:	00 
  800d2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d35:	00 
  800d36:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800d3d:	e8 27 f4 ff ff       	call   800169 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d78:	00 
  800d79:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800d80:	00 
  800d81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d88:	00 
  800d89:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800d90:	e8 d4 f3 ff ff       	call   800169 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800de3:	e8 81 f3 ff ff       	call   800169 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e1e:	00 
  800e1f:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800e36:	e8 2e f3 ff ff       	call   800169 <_panic>
int
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e71:	00 
  800e72:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800e79:	00 
  800e7a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e81:	00 
  800e82:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800e89:	e8 db f2 ff ff       	call   800169 <_panic>
int
...
sys_ipc_recv(void *dstva)
{
  ...
  800ee6:	00 
  800ee7:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800eee:	00 
  800eef:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ef6:	00 
  800ef7:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800efe:	e8 66 f2 ff ff       	call   800169 <_panic>
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800f58:	00 
  800f59:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800f60:	00 
  800f61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f68:	00 
  800f69:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800f70:	e8 f4 f1 ff ff       	call   800169 <_panic>
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800fab:	00 
  800fac:	c7 44 24 08 3f 2a 80 	movl   $0x802a3f,0x8(%esp)
  800fb3:	00 
  800fb4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fbb:	00 
  800fbc:	c7 04 24 5c 2a 80 00 	movl   $0x802a5c,(%esp)
  800fc3:	e8 a1 f1 ff ff       	call   800169 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010bf:	8b 04 95 ec 2a 80 00 	mov    0x802aec(,%edx,4),%eax
  ...
  8010da:	c7 04 24 6c 2a 80 00 	movl   $0x802a6c,(%esp)
  8010e1:	e8 7c f1 ff ff       	call   800262 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80132f:	c7 04 24 b0 2a 80 00 	movl   $0x802ab0,(%esp)
  801336:	e8 27 ef ff ff       	call   800262 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801407:	c7 04 24 cc 2a 80 00 	movl   $0x802acc,(%esp)
  80140e:	e8 4f ee ff ff       	call   800262 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014c0:	c7 04 24 8c 2a 80 00 	movl   $0x802a8c,(%esp)
  8014c7:	e8 96 ed ff ff       	call   800262 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015cf:	e8 7a 0d 00 00       	call   80234e <ipc_find_env>
  ...
  8015f5:	e8 f6 0c 00 00       	call   8022f0 <ipc_send>
  ...
  80160d:	e8 74 0c 00 00       	call   802286 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8016d6:	a3 04 50 c0 00       	mov    %eax,0xc05004
    fsipcbuf.write.req_fileid = fd->fd_file.id;
  8016db:	8b 55 08             	mov    0x8(%ebp),%edx
  8016de:	8b 52 0c             	mov    0xc(%edx),%edx
  8016e1:	89 15 00 50 c0 00    	mov    %edx,0xc05000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801744:	c7 44 24 0c 00 2b 80 	movl   $0x802b00,0xc(%esp)
  80174b:	00 
  80174c:	c7 44 24 08 07 2b 80 	movl   $0x802b07,0x8(%esp)
  801753:	00 
  801754:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80175b:	00 
  80175c:	c7 04 24 1c 2b 80 00 	movl   $0x802b1c,(%esp)
  801763:	e8 01 ea ff ff       	call   800169 <_panic>
	assert(r <= PGSIZE);
  801768:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80176d:	7e 24                	jle    801793 <devfile_read+0x84>
  80176f:	c7 44 24 0c 27 2b 80 	movl   $0x802b27,0xc(%esp)
  801776:	00 
  801777:	c7 44 24 08 07 2b 80 	movl   $0x802b07,0x8(%esp)
  80177e:	00 
  80177f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801786:	00 
  801787:	c7 04 24 1c 2b 80 00 	movl   $0x802b1c,(%esp)
  80178e:	e8 d6 e9 ff ff       	call   800169 <_panic>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801856:	c7 44 24 04 33 2b 80 	movl   $0x802b33,0x4(%esp)
  80185d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  80187d:	e8 04 0b 00 00       	call   802386 <pageref>
...
nsipc(unsigned type)
{
  ...
  801abc:	e8 8d 08 00 00       	call   80234e <ipc_find_env>
  ...
  801ae2:	e8 09 08 00 00       	call   8022f0 <ipc_send>
  ...
  801afe:	e8 83 07 00 00       	call   802286 <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c77:	c7 44 24 0c 3f 2b 80 	movl   $0x802b3f,0xc(%esp)
  801c7e:	00 
  801c7f:	c7 44 24 08 07 2b 80 	movl   $0x802b07,0x8(%esp)
  801c86:	00 
  801c87:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801c8e:	00 
  801c8f:	c7 04 24 54 2b 80 00 	movl   $0x802b54,(%esp)
  801c96:	e8 ce e4 ff ff       	call   800169 <_panic>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801cd5:	c7 44 24 0c 60 2b 80 	movl   $0x802b60,0xc(%esp)
  801cdc:	00 
  801cdd:	c7 44 24 08 07 2b 80 	movl   $0x802b07,0x8(%esp)
  801ce4:	00 
  801ce5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801cec:	00 
  801ced:	c7 04 24 54 2b 80 00 	movl   $0x802b54,(%esp)
  801cf4:	e8 70 e4 ff ff       	call   800169 <_panic>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d70:	c7 44 24 04 6c 2b 80 	movl   $0x802b6c,0x4(%esp)
  801d77:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e36:	c7 04 24 73 2b 80 00 	movl   $0x802b73,(%esp)
  801e3d:	e8 20 e4 ff ff       	call   800262 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8020f0:	c7 44 24 04 8b 2b 80 	movl   $0x802b8b,0x4(%esp)
  8020f7:	00 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80228e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  802297:	85 c0                	test   %eax,%eax
		pg = (void*)0xfffffffff;
  802299:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  80229e:	0f 44 c2             	cmove  %edx,%eax
	if((pg!=NULL))
	{
		if((return_code=sys_ipc_recv(pg))==0)
  8022a1:	89 04 24             	mov    %eax,(%esp)
  8022a4:	e8 10 ec ff ff       	call   800eb9 <sys_ipc_recv>
  8022a9:	85 c0                	test   %eax,%eax
  8022ab:	75 1e                	jne    8022cb <ipc_recv+0x45>
		{
			if(from_env_store!=NULL)
  8022ad:	85 db                	test   %ebx,%ebx
  8022af:	74 0a                	je     8022bb <ipc_recv+0x35>
			*from_env_store = thisenv->env_ipc_from;
  8022b1:	a1 20 40 c0 00       	mov    0xc04020,%eax
  8022b6:	8b 40 74             	mov    0x74(%eax),%eax
  8022b9:	89 03                	mov    %eax,(%ebx)
			if(perm_store!=NULL)
  8022bb:	85 f6                	test   %esi,%esi
  8022bd:	74 22                	je     8022e1 <ipc_recv+0x5b>
			*perm_store = thisenv->env_ipc_perm;
  8022bf:	a1 20 40 c0 00       	mov    0xc04020,%eax
  8022c4:	8b 40 78             	mov    0x78(%eax),%eax
  8022c7:	89 06                	mov    %eax,(%esi)
  8022c9:	eb 16                	jmp    8022e1 <ipc_recv+0x5b>
		}
		else
		{
			if(perm_store!=NULL)
  8022cb:	85 f6                	test   %esi,%esi
  8022cd:	74 06                	je     8022d5 <ipc_recv+0x4f>
				*perm_store = 0;
  8022cf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
			if(from_env_store!=NULL)
  8022d5:	85 db                	test   %ebx,%ebx
  8022d7:	74 10                	je     8022e9 <ipc_recv+0x63>
				*from_env_store=0;
  8022d9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8022df:	eb 08                	jmp    8022e9 <ipc_recv+0x63>
			return return_code;
		}
		
	}
return thisenv->env_ipc_value;
  8022e1:	a1 20 40 c0 00       	mov    0xc04020,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022f4:	56                   	push   %esi
  8022f5:	53                   	push   %ebx
  8022f6:	83 ec 1c             	sub    $0x1c,%esp
  8022f9:	8b 75 0c             	mov    0xc(%ebp),%esi
  8022fc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8022ff:	8b 7d 14             	mov    0x14(%ebp),%edi
	// LAB 4: Your code here.

	if(pg ==NULL)
  802302:	85 db                	test   %ebx,%ebx
		pg = (void*)KERNBASE;
  802304:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  802309:	0f 44 d8             	cmove  %eax,%ebx
	int return_code = sys_ipc_try_send(to_env,val,pg,perm);
  80230c:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  ...
  80231e:	e8 73 eb ff ff       	call   800e96 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802323:	eb 1c                	jmp    802341 <ipc_send+0x51>
	{
		sys_yield();
  802325:	e8 5a e9 ff ff       	call   800c84 <sys_yield>
  ...
  80233c:	e8 55 eb ff ff       	call   800e96 <sys_ipc_try_send>
	// LAB 4: Your code here.
  ...
  802344:	74 df                	je     802325 <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  802367:	75 0d                	jne    802376 <ipc_find_env+0x28>
			return envs[i].env_id;
  802369:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80236c:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  802371:	8b 40 40             	mov    0x40(%eax),%eax
  802374:	eb 0e                	jmp    802384 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80237e:	75 d9                	jne    802359 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  802380:	66 b8 00 00          	mov    $0x0,%ax
}
  802384:	5d                   	pop    %ebp
  802385:	c3                   	ret    
