...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 c0 25 80 00 	movl   $0x8025c0,(%esp)
  80005b:	e8 10 01 00 00       	call   800170 <cprintf>
}
  800060:	c9                   	leave  
  800061:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006d:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800070:	c7 05 0c 40 80 00 00 	movl   $0x0,0x80400c
  800077:	00 00 00 
  ...
  800093:	7e 07                	jle    80009c <libmain+0x3a>
		binaryname = argv[0];
...
exit(void)
{
  ...
  8000b7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ba:	e8 fb 0f 00 00       	call   8010ba <close_all>
	sys_env_destroy(0);
  8000bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000c6:	e8 58 0a 00 00       	call   800b23 <sys_env_destroy>
}
  8000cb:	c9                   	leave  
  8000cc:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ea:	75 19                	jne    800105 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8000ec:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8000f3:	00 
  8000f4:	8d 43 08             	lea    0x8(%ebx),%eax
  8000f7:	89 04 24             	mov    %eax,(%esp)
  8000fa:	e8 e7 09 00 00       	call   800ae6 <sys_cputs>
		b->idx = 0;
  8000ff:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800105:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800144:	c7 04 24 cd 00 80 00 	movl   $0x8000cd,(%esp)
  80014b:	e8 ae 01 00 00       	call   8002fe <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800163:	e8 7e 09 00 00       	call   800ae6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ff:	e8 2c 21 00 00       	call   802330 <__udivdi3>
  ...
  80025f:	e8 fc 21 00 00       	call   802460 <__umoddi3>
  800264:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800268:	0f be 80 d8 25 80 00 	movsbl 0x8025d8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800383:	ff 24 8d 20 27 80 00 	jmp    *0x802720(,%ecx,4)
  ...
  80044f:	c7 44 24 08 b5 29 80 	movl   $0x8029b5,0x8(%esp)
  800456:	00 
  ...
  800481:	b8 e9 25 80 00       	mov    $0x8025e9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b50:	00 
  800b51:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800b58:	00 
  800b59:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b60:	00 
  800b61:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be2:	00 
  800be3:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800bea:	00 
  800beb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf2:	00 
  800bf3:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c35:	00 
  800c36:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c3d:	00 
  800c3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c45:	00 
  800c46:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdb:	00 
  800cdc:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800ce3:	00 
  800ce4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ceb:	00 
  800cec:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d2e:	00 
  800d2f:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d36:	00 
  800d37:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3e:	00 
  800d3f:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800df6:	00 
  800df7:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800dfe:	00 
  800dff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e06:	00 
  800e07:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_e1000_transmit(char *data,int len)
{
  ...
  800e5b:	7e 28                	jle    800e85 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800e5d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800e61:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800e68:	00 
  800e69:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800e70:	00 
  800e71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e78:	00 
  800e79:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  800eae:	7e 28                	jle    800ed8 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800eb0:	89 44 24 10          	mov    %eax,0x10(%esp)
  800eb4:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800ebb:	00 
  800ebc:	c7 44 24 08 df 28 80 	movl   $0x8028df,0x8(%esp)
  800ec3:	00 
  800ec4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ecb:	00 
  800ecc:	c7 04 24 fc 28 80 00 	movl   $0x8028fc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fcf:	8b 04 95 88 29 80 00 	mov    0x802988(,%edx,4),%eax
  ...
  800fea:	c7 04 24 0c 29 80 00 	movl   $0x80290c,(%esp)
  800ff1:	e8 7a f1 ff ff       	call   800170 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80122f:	a1 0c 40 80 00       	mov    0x80400c,%eax
  801234:	8b 40 48             	mov    0x48(%eax),%eax
  801237:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80123b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80123f:	c7 04 24 4d 29 80 00 	movl   $0x80294d,(%esp)
  801246:	e8 25 ef ff ff       	call   800170 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801307:	a1 0c 40 80 00       	mov    0x80400c,%eax
  80130c:	8b 40 48             	mov    0x48(%eax),%eax
  80130f:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801313:	89 44 24 04          	mov    %eax,0x4(%esp)
  801317:	c7 04 24 69 29 80 00 	movl   $0x802969,(%esp)
  80131e:	e8 4d ee ff ff       	call   800170 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013be:	75 23                	jne    8013e3 <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8013c0:	a1 0c 40 80 00       	mov    0x80400c,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  8013d0:	c7 04 24 2c 29 80 00 	movl   $0x80292c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  8014df:	e8 d0 0d 00 00       	call   8022b4 <ipc_find_env>
  ...
  801505:	e8 4c 0d 00 00       	call   802256 <ipc_send>
  ...
  80151d:	e8 ca 0c 00 00       	call   8021ec <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8015ee:	8b 52 0c             	mov    0xc(%edx),%edx
  8015f1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801654:	c7 44 24 0c 9c 29 80 	movl   $0x80299c,0xc(%esp)
  80165b:	00 
  80165c:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801663:	00 
  801664:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80166b:	00 
  80166c:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
  801673:	e8 1e 0b 00 00       	call   802196 <_panic>
	assert(r <= PGSIZE);
  801678:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80167d:	7e 24                	jle    8016a3 <devfile_read+0x84>
  80167f:	c7 44 24 0c c3 29 80 	movl   $0x8029c3,0xc(%esp)
  801686:	00 
  801687:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  80168e:	00 
  80168f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801696:	00 
  801697:	c7 04 24 b8 29 80 00 	movl   $0x8029b8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801766:	c7 44 24 04 cf 29 80 	movl   $0x8029cf,0x4(%esp)
  80176d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  80178d:	e8 5a 0b 00 00       	call   8022ec <pageref>
...
nsipc(unsigned type)
{
  ...
  8019cc:	e8 e3 08 00 00       	call   8022b4 <ipc_find_env>
  ...
  8019f2:	e8 5f 08 00 00       	call   802256 <ipc_send>
  ...
  801a0e:	e8 d9 07 00 00       	call   8021ec <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b87:	c7 44 24 0c db 29 80 	movl   $0x8029db,0xc(%esp)
  801b8e:	00 
  801b8f:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801b96:	00 
  801b97:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801b9e:	00 
  801b9f:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801be5:	c7 44 24 0c fc 29 80 	movl   $0x8029fc,0xc(%esp)
  801bec:	00 
  801bed:	c7 44 24 08 a3 29 80 	movl   $0x8029a3,0x8(%esp)
  801bf4:	00 
  801bf5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801bfc:	00 
  801bfd:	c7 04 24 f0 29 80 00 	movl   $0x8029f0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c80:	c7 44 24 04 08 2a 80 	movl   $0x802a08,0x4(%esp)
  801c87:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d46:	c7 04 24 0f 2a 80 00 	movl   $0x802a0f,(%esp)
  801d4d:	e8 1e e4 ff ff       	call   800170 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802000:	c7 44 24 04 27 2a 80 	movl   $0x802a27,0x4(%esp)
  802007:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021c2:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
  8021c9:	e8 a2 df ff ff       	call   800170 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8021ce:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8021d2:	8b 45 10             	mov    0x10(%ebp),%eax
  8021d5:	89 04 24             	mov    %eax,(%esp)
  8021d8:	e8 32 df ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  8021dd:	c7 04 24 cc 25 80 00 	movl   $0x8025cc,(%esp)
  8021e4:	e8 87 df ff ff       	call   800170 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8021fd:	85 c0                	test   %eax,%eax
		pg = (void*)0xfffffffff;
  8021ff:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  802204:	0f 44 c2             	cmove  %edx,%eax
	if((pg!=NULL))
	{
		if((return_code=sys_ipc_recv(pg))==0)
  802207:	89 04 24             	mov    %eax,(%esp)
  80220a:	e8 ba eb ff ff       	call   800dc9 <sys_ipc_recv>
  80220f:	85 c0                	test   %eax,%eax
  802211:	75 1e                	jne    802231 <ipc_recv+0x45>
		{
			if(from_env_store!=NULL)
  802213:	85 db                	test   %ebx,%ebx
  802215:	74 0a                	je     802221 <ipc_recv+0x35>
			*from_env_store = thisenv->env_ipc_from;
  802217:	a1 0c 40 80 00       	mov    0x80400c,%eax
  80221c:	8b 40 74             	mov    0x74(%eax),%eax
  80221f:	89 03                	mov    %eax,(%ebx)
			if(perm_store!=NULL)
  802221:	85 f6                	test   %esi,%esi
  802223:	74 22                	je     802247 <ipc_recv+0x5b>
			*perm_store = thisenv->env_ipc_perm;
  802225:	a1 0c 40 80 00       	mov    0x80400c,%eax
  80222a:	8b 40 78             	mov    0x78(%eax),%eax
  80222d:	89 06                	mov    %eax,(%esi)
  80222f:	eb 16                	jmp    802247 <ipc_recv+0x5b>
		}
		else
		{
			if(perm_store!=NULL)
  802231:	85 f6                	test   %esi,%esi
  802233:	74 06                	je     80223b <ipc_recv+0x4f>
				*perm_store = 0;
  802235:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
			if(from_env_store!=NULL)
  80223b:	85 db                	test   %ebx,%ebx
  80223d:	74 10                	je     80224f <ipc_recv+0x63>
				*from_env_store=0;
  80223f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  802245:	eb 08                	jmp    80224f <ipc_recv+0x63>
			return return_code;
		}
		
	}
return thisenv->env_ipc_value;
  802247:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80225f:	8b 75 0c             	mov    0xc(%ebp),%esi
  802262:	8b 5d 10             	mov    0x10(%ebp),%ebx
  802265:	8b 7d 14             	mov    0x14(%ebp),%edi
	// LAB 4: Your code here.

	if(pg ==NULL)
  802268:	85 db                	test   %ebx,%ebx
		pg = (void*)KERNBASE;
  80226a:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  80226f:	0f 44 d8             	cmove  %eax,%ebx
	int return_code = sys_ipc_try_send(to_env,val,pg,perm);
  802272:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802276:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80227a:	89 74 24 04          	mov    %esi,0x4(%esp)
  80227e:	8b 45 08             	mov    0x8(%ebp),%eax
  802281:	89 04 24             	mov    %eax,(%esp)
  802284:	e8 1d eb ff ff       	call   800da6 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  802289:	eb 1c                	jmp    8022a7 <ipc_send+0x51>
	{
		sys_yield();
  80228b:	e8 04 e9 ff ff       	call   800b94 <sys_yield>
		return_code = sys_ipc_try_send(to_env,val,pg,perm);
  802290:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802294:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  802298:	89 74 24 04          	mov    %esi,0x4(%esp)
  80229c:	8b 45 08             	mov    0x8(%ebp),%eax
  80229f:	89 04 24             	mov    %eax,(%esp)
  8022a2:	e8 ff ea ff ff       	call   800da6 <sys_ipc_try_send>
	// LAB 4: Your code here.
  ...
  8022aa:	74 df                	je     80228b <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  8022bf:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8022c2:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8022c8:	8b 52 50             	mov    0x50(%edx),%edx
  8022cb:	39 ca                	cmp    %ecx,%edx
  8022cd:	75 0d                	jne    8022dc <ipc_find_env+0x28>
			return envs[i].env_id;
  8022cf:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8022d2:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8022d7:	8b 40 40             	mov    0x40(%eax),%eax
  8022da:	eb 0e                	jmp    8022ea <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8022e4:	75 d9                	jne    8022bf <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
