...
umain(int argc, char **argv)
{
  ...
  80004e:	c7 44 24 04 40 26 80 	movl   $0x802640,0x4(%esp)
  800055:	00 
  ...
  80006f:	83 c6 04             	add    $0x4,%esi
{
  ...
  80008c:	00 
  80008d:	c7 44 24 04 43 26 80 	movl   $0x802643,0x4(%esp)
  800094:	00 
  ...
  8000d7:	00 
  8000d8:	c7 44 24 04 90 27 80 	movl   $0x802790,0x4(%esp)
  8000df:	00 
...
libmain(int argc, char **argv)
{
  ...
  80010c:	e8 64 04 00 00       	call   800575 <sys_getenvid>
...
exit(void)
{
  ...
  800149:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80014c:	e8 69 09 00 00       	call   800aba <close_all>
	sys_env_destroy(0);
  800151:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800158:	e8 c6 03 00 00       	call   800523 <sys_env_destroy>
}
  80015d:	c9                   	leave  
  80015e:	c3                   	ret    
  80015f:	90                   	nop
...
sys_env_destroy(envid_t envid)
{
  ...
  800550:	00 
  800551:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  800558:	00 
  800559:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800560:	00 
  800561:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8005e2:	00 
  8005e3:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  8005ea:	00 
  8005eb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8005f2:	00 
  8005f3:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800635:	00 
  800636:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  80063d:	00 
  80063e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800645:	00 
  800646:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800688:	00 
  800689:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  800690:	00 
  800691:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800698:	00 
  800699:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8006db:	00 
  8006dc:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  8006e3:	00 
  8006e4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8006eb:	00 
  8006ec:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80072e:	00 
  80072f:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  800736:	00 
  800737:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80073e:	00 
  80073f:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800781:	00 
  800782:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  800789:	00 
  80078a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800791:	00 
  800792:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8007f6:	00 
  8007f7:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  8007fe:	00 
  8007ff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800806:	00 
  800807:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_e1000_transmit(char *data,int len)
{
  ...
  80085b:	7e 28                	jle    800885 <sys_e1000_transmit+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80085d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800861:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800868:	00 
  800869:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  800870:	00 
  800871:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800878:	00 
  800879:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
sys_e1000_recieve(char *data ,int *len)
{
  ...
  8008ae:	7e 28                	jle    8008d8 <sys_e1000_recieve+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8008b0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8008b4:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  8008bb:	00 
  8008bc:	c7 44 24 08 4f 26 80 	movl   $0x80264f,0x8(%esp)
  8008c3:	00 
  8008c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8008cb:	00 
  8008cc:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8009cf:	8b 04 95 f8 26 80 00 	mov    0x8026f8(,%edx,4),%eax
  ...
  8009ea:	c7 04 24 7c 26 80 00 	movl   $0x80267c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800c3f:	c7 04 24 bd 26 80 00 	movl   $0x8026bd,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800d17:	c7 04 24 d9 26 80 00 	movl   $0x8026d9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800dd0:	c7 04 24 9c 26 80 00 	movl   $0x80269c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800edf:	e8 56 14 00 00       	call   80233a <ipc_find_env>
  ...
  800f05:	e8 d2 13 00 00       	call   8022dc <ipc_send>
  ...
  800f1d:	e8 50 13 00 00       	call   802272 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800fe6:	a3 04 50 80 00       	mov    %eax,0x805004
    fsipcbuf.write.req_fileid = fd->fd_file.id;
  800feb:	8b 55 08             	mov    0x8(%ebp),%edx
  800fee:	8b 52 0c             	mov    0xc(%edx),%edx
  800ff1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801054:	c7 44 24 0c 0c 27 80 	movl   $0x80270c,0xc(%esp)
  80105b:	00 
  80105c:	c7 44 24 08 13 27 80 	movl   $0x802713,0x8(%esp)
  801063:	00 
  801064:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80106b:	00 
  80106c:	c7 04 24 28 27 80 00 	movl   $0x802728,(%esp)
  801073:	e8 1e 0b 00 00       	call   801b96 <_panic>
	assert(r <= PGSIZE);
  801078:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80107d:	7e 24                	jle    8010a3 <devfile_read+0x84>
  80107f:	c7 44 24 0c 33 27 80 	movl   $0x802733,0xc(%esp)
  801086:	00 
  801087:	c7 44 24 08 13 27 80 	movl   $0x802713,0x8(%esp)
  80108e:	00 
  80108f:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801096:	00 
  801097:	c7 04 24 28 27 80 00 	movl   $0x802728,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801166:	c7 44 24 04 3f 27 80 	movl   $0x80273f,0x4(%esp)
  80116d:	00 
...
devsock_close(struct Fd *fd)
{
  ...
  80118d:	e8 e0 11 00 00       	call   802372 <pageref>
...
nsipc(unsigned type)
{
  ...
  8013cc:	e8 69 0f 00 00       	call   80233a <ipc_find_env>
  ...
  8013f2:	e8 e5 0e 00 00       	call   8022dc <ipc_send>
  ...
  80140e:	e8 5f 0e 00 00       	call   802272 <ipc_recv>
}
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801587:	c7 44 24 0c 4b 27 80 	movl   $0x80274b,0xc(%esp)
  80158e:	00 
  80158f:	c7 44 24 08 13 27 80 	movl   $0x802713,0x8(%esp)
  801596:	00 
  801597:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80159e:	00 
  80159f:	c7 04 24 60 27 80 00 	movl   $0x802760,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8015e5:	c7 44 24 0c 6c 27 80 	movl   $0x80276c,0xc(%esp)
  8015ec:	00 
  8015ed:	c7 44 24 08 13 27 80 	movl   $0x802713,0x8(%esp)
  8015f4:	00 
  8015f5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8015fc:	00 
  8015fd:	c7 04 24 60 27 80 00 	movl   $0x802760,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801680:	c7 44 24 04 78 27 80 	movl   $0x802778,0x4(%esp)
  801687:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801746:	c7 04 24 7f 27 80 00 	movl   $0x80277f,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a00:	c7 44 24 04 97 27 80 	movl   $0x802797,0x4(%esp)
  801a07:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801bc2:	c7 04 24 a4 27 80 00 	movl   $0x8027a4,(%esp)
  ...
  801bd8:	e8 51 00 00 00       	call   801c2e <vcprintf>
	cprintf("\n");
  801bdd:	c7 04 24 90 27 80 00 	movl   $0x802790,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801d1f:	e8 8c 06 00 00       	call   8023b0 <__udivdi3>
  ...
  801d7f:	e8 5c 07 00 00       	call   8024e0 <__umoddi3>
  801d84:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801d88:	0f be 80 c7 27 80 00 	movsbl 0x8027c7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801ea3:	ff 24 8d 00 29 80 00 	jmp    *0x802900(,%ecx,4)
  ...
  801f6f:	c7 44 24 08 25 27 80 	movl   $0x802725,0x8(%esp)
  801f76:	00 
  ...
  801fa1:	b8 d8 27 80 00       	mov    $0x8027d8,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802280:	8b 75 10             	mov    0x10(%ebp),%esi
  ...
  802283:	85 c0                	test   %eax,%eax
		pg = (void*)0xfffffffff;
  802285:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  80228a:	0f 44 c2             	cmove  %edx,%eax
	if((pg!=NULL))
	{
		if((return_code=sys_ipc_recv(pg))==0)
  80228d:	89 04 24             	mov    %eax,(%esp)
  802290:	e8 34 e5 ff ff       	call   8007c9 <sys_ipc_recv>
  802295:	85 c0                	test   %eax,%eax
  802297:	75 1e                	jne    8022b7 <ipc_recv+0x45>
		{
			if(from_env_store!=NULL)
  802299:	85 db                	test   %ebx,%ebx
  80229b:	74 0a                	je     8022a7 <ipc_recv+0x35>
			*from_env_store = thisenv->env_ipc_from;
  80229d:	a1 08 40 80 00       	mov    0x804008,%eax
  8022a2:	8b 40 74             	mov    0x74(%eax),%eax
  8022a5:	89 03                	mov    %eax,(%ebx)
			if(perm_store!=NULL)
  8022a7:	85 f6                	test   %esi,%esi
  8022a9:	74 22                	je     8022cd <ipc_recv+0x5b>
			*perm_store = thisenv->env_ipc_perm;
  8022ab:	a1 08 40 80 00       	mov    0x804008,%eax
  8022b0:	8b 40 78             	mov    0x78(%eax),%eax
  8022b3:	89 06                	mov    %eax,(%esi)
  8022b5:	eb 16                	jmp    8022cd <ipc_recv+0x5b>
		}
		else
		{
			if(perm_store!=NULL)
  8022b7:	85 f6                	test   %esi,%esi
  8022b9:	74 06                	je     8022c1 <ipc_recv+0x4f>
				*perm_store = 0;
  8022bb:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
			if(from_env_store!=NULL)
  8022c1:	85 db                	test   %ebx,%ebx
  8022c3:	74 10                	je     8022d5 <ipc_recv+0x63>
				*from_env_store=0;
  8022c5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8022cb:	eb 08                	jmp    8022d5 <ipc_recv+0x63>
			return return_code;
		}
		
	}
return thisenv->env_ipc_value;
  8022cd:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022eb:	8b 7d 14             	mov    0x14(%ebp),%edi
	// LAB 4: Your code here.

	if(pg ==NULL)
  8022ee:	85 db                	test   %ebx,%ebx
		pg = (void*)KERNBASE;
  8022f0:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  8022f5:	0f 44 d8             	cmove  %eax,%ebx
	int return_code = sys_ipc_try_send(to_env,val,pg,perm);
  8022f8:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8022fc:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  802300:	89 74 24 04          	mov    %esi,0x4(%esp)
  802304:	8b 45 08             	mov    0x8(%ebp),%eax
  802307:	89 04 24             	mov    %eax,(%esp)
  80230a:	e8 97 e4 ff ff       	call   8007a6 <sys_ipc_try_send>
	while(return_code == -E_IPC_NOT_RECV)
  80230f:	eb 1c                	jmp    80232d <ipc_send+0x51>
	{
		sys_yield();
  802311:	e8 7e e2 ff ff       	call   800594 <sys_yield>
  ...
  802330:	74 df                	je     802311 <ipc_send+0x35>
...
ipc_find_env(enum EnvType type)
{
  ...
  802353:	75 0d                	jne    802362 <ipc_find_env+0x28>
			return envs[i].env_id;
  802355:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802358:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80235d:	8b 40 40             	mov    0x40(%eax),%eax
  802360:	eb 0e                	jmp    802370 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  802362:	83 c0 01             	add    $0x1,%eax
  802365:	3d 00 04 00 00       	cmp    $0x400,%eax
  80236a:	75 d9                	jne    802345 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80236c:	66 b8 00 00          	mov    $0x0,%ax
}
  802370:	5d                   	pop    %ebp
  802371:	c3                   	ret    
...
pageref(void *v)
{
  ...
  80237a:	c1 e8 16             	shr    $0x16,%eax
  80237d:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  802389:	f6 c1 01             	test   $0x1,%cl
  80238c:	74 1d                	je     8023ab <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  80238e:	c1 ea 0c             	shr    $0xc,%edx
  802391:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  802398:	f6 c2 01             	test   $0x1,%dl
  80239b:	74 0e                	je     8023ab <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  80239d:	c1 ea 0c             	shr    $0xc,%edx
  8023a0:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  8023a7:	ef 
  8023a8:	0f b7 c0             	movzwl %ax,%eax
}
  8023ab:	5d                   	pop    %ebp
  8023ac:	c3                   	ret    
